 ...
 <div class="sidebar-inner">
   ...
   <div class="dropdown dropdown-actions">
     <button
       class="btn btn-primary add-file-btn text-center w-100 allFolders"
       type="button"
       id="addNewFilex"
...
<div class="file-manager-main-content">
 ...
 <div class="file-manager-content-header d-flex justify-content-between align-items-center">
   ...
   <div class="d-flex align-items-center">
      ...
      <a href="#" class="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#new-folder-file-modal" >+ Add Files</a>     
     <div class="file-actions">
         <?php if($this->encrypt->decode($this->session->userdata('get_investor_id')) !=''){ ?>
       <button type="submit" class="btn btn-primary mt-1 me-1 sendBtn">Send to  <?php 
       $InvestorId = $this->encrypt->decode($this->session->userdata('get_investor_id'));
      $InvestorName = $this->admin_model->getAllInvestorById($InvestorId)[0]['Contact_Name'] ; 
       echo  $InvestorName;
       
       ?></button>
         <?php }else {  ?> 
         <a href="#" class="btn btn-primary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#new-folder-modal" disabled>Send to investor</a>
         
         <a href="#" class="btn btn-secondary mt-1 me-1" data-bs-toggle="modal" data-bs-target="#new-folder-modalX" disabled>Send to <br> third party</a>
         <?php }  ?>
 ...
 <div class="file-manager-content-body">
   ...
   <div class="view-container">
     <h6 class="files-section-title mt-2 mb-75"><?php if(!empty($folder_name)){ echo $folder_name; }else{ echo "No Files in this folder."; } ?></h6>
     <input type="hidden" class="folder_name" name='folder_name' value='<?php echo $folder_name; ?>'>
     <?php
               
               $row = $this->gfa_model->getFileUploaded($email,$folder_name);
...
<div class="modal fade" id="new-folder-file-modal">
...
<option value="Videos">Videos</option>
     ...
     <div class="modal-footer">
       ...
       <span class="displayActionX"></span>
     </div>
      </form>
   </div>
 </div>
...
<div class="modal fade" id="new-folder-modalX">
 <div class="modal-dialog modal-dialog-centered modal-sm">
   <div class="modal-content">
     ...
     <div class="modal-body">
      <form class="sendToThirdParty" method="post" action="" enctype="multipart/form-data">
     <div class="modal-body">
         
     
           
           <div class="col-12 col-sm-12 mb-1">
             <label class="form-label" for="accountFirstName">Enter Investor email</label>
             <input
               type="email"
               class="form-control"
               id="accountFirstName"
     ...
     <div class="modal-footer">
       <button type="submit" class="btn btn-primary me-1 saveBtnThird" >Send</button>
       <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</button>
       <span class="displayThirdParty"></span>
     </div>
      </form>  
...
<script>
   ...
   contentType: false,
     success: function(data) {
       ...
       window.open("<?php echo base_url(); ?>gfa/dealroom_folder/"+folder_name, "_self");
 ...
 return false;
  ...
  $.ajax({
    ...
    data:id,
    type: "POST",
    url: "<?php echo base_url(); ?>gfa/sendToThirdParty",
    error:function() {$(".saveBtnThird").html('Error loading Data');},
    beforeSend:function() {$(".saveBtnThird").html('Sending data...'); $(".saveBtnThird").prop('disabled',true);},
    success: function(data) {
       
       $(".saveBtnThird").html('Message Sent');
       $(".displayThirdParty").html(data);
       //$(".sendAction").html(data);
       $(".saveBtnThird").prop('disabled',true);
