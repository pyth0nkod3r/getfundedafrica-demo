    ...
    <div class="app-content content ">
      ...
      <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Manage Quiz</h2>
          ...
          <div class="table-responsive">
            ...
            <table class="table tablemanager">
              ...
              <tbody class="loadCorperate">
               ...
               <a href="<?php echo base_url()?>gfa/quiz/<?php echo $rowArray['ref_id']; ?>" ><i data-feather="external-link" class="text-success font-medium-1"></i>View</a> |
               <a href="<?php echo base_url()?>gfa/edit_quiz/<?php echo $rowArray['id']; ?>" ><i data-feather="edit" class="text-success font-medium-1"></i>Edit</a> | 
               <a href="#" alt="delete Quiz" class="deletebtn"><i data-feather="trash" class="text-success font-medium-1"></i>Delete<span style="display: none;"><?php echo $rowArray['id'] ?></span></a>  
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                      <div class="fw-bolder">
                        <?php echo $this->gfa_model->getCourseById($rowArray['course_id'])[0]['coursetitle']; ?><br>
                        [<?php echo $this->gfa_model->getSectionByCourseId($rowArray['course_id'])[0]['title']; ?>]
                    </div>
                 ...
                 <td>
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <div class="fw-bolder"><?php echo ucwords($this->gfa_model->getLessonById($rowArray['lesson_id'])[0]['title']); ?></div>
                      </div>
                    </div>
                  </td>
                  </td>
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <div class="fw-bolder">Questions(<?php echo $this->gfa_model->countQuizQuestion($rowArray['ref_id']);?>)</div>
                      </div>
                    </div>
                  </td>
...
tempInput.remove();
  ...
  $(this).closest('tr').remove();
    ...
    $.ajax({
     data:{id:id},
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/deleteQuiz",
