  ...
  $this->admin_model = model('App\Models\AdminModel');
   ?>
            ...
            <?php
            	...
            	$row = $this->admin_model->matchAllSme($PrimaryBusinessIndustry,$Primary_Contact_Name,$Startup_Implementation_Stage); 
            if(!empty($row)){
              $n = 1;
              $s = 1;	
              $count = 0;
            ...
            ?>
                ...
                <td>
                   ...
                   <i data-feather="trending-up" class="text-success font-medium-1"></i> &nbsp;        
                      ...
                      <a href="<?php echo base_url(); ?>gfa/sme_startup_details/<?php echo $rowArrays['STUP_ID'] ; ?>" class="btn btn-primary getStartups"><?php echo lang('translation.Connect') ?> <span style="display: none;"><?php echo $rowArrays['STUP_ID'] ?></a>
