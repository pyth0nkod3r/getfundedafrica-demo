    ...
    <div class="app-content content ">
      ...
      <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Manage Perks Requested</h2>
          ...
          <div class="table-responsive">
            ...
            <table class="table">
              ...
              <tbody class="loadCorperate">
                ...
                $row = $this->gfa_model->getAllPerksRedeem();
                }else{

                    $row = $this->gfa_model->getPerksByEmailRedeem($email);  
                }
                ...
                <td>
                    <div class="d-flex align-items-center">
                      ...
                      <span><div class="fw-bolder"><?php echo $rowArray['time_submit'] ?></div></span>
                    </div>
                  </td>
                  <td>
                    <div class="d-flex align-items-center">
              ...
              <?php if($rowArray['status']=='active'){ echo '';}else{ ?> | 
...
tempInput.remove();
  ...
  $(this).closest('tr').remove();
    ...
    $.ajax({
     data:{id:id},
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/deletePerksRedeem",
