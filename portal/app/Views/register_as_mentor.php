              ...
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Mentor Profile </a>
                    </li>
  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-header border-bottom">
        <h4 class="card-title">Mentor Profile Details</h4>
      </div>
      <?php  
        ...
        <form class="validate-form mt-2 pt-50 startUpForm" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <select id="country" name="country" class="select2 form-select">
                <option value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['Nationality'];  ?>"><?php echo $this->gfa_model->getMentorDetails($email)[0]['Nationality'];  ?></option>
...
<option value="Zimbabwe">Zimbabwe</option> 
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <input type="text" class="form-control" id="accountState" name="state" placeholder="State" value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['City'];  ?>" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">Designation/Role</label>
              <input type="text" class="form-control" id="accountAddress" name="address" placeholder="Designation/Role" value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['Role'];  ?>" />
            </div>
            
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountZipCode">No of Mentees</label>
              <input
                type="text"
  ...
  <!--<legend>Investment Validation</legend>-->
          ...
          <div class="col-12 col-sm-6 mb-1">
              ...
              <select id="country" name="Gender" class="select2 form-select">
                  <option value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['Gender'];  ?>"><?php echo $this->gfa_model->getMentorDetails($email)[0]['Gender'];  ?></option>
            ...
            <div class="col-12 col-sm-6 mb-1">
             ...
             <div class="col-12 col-sm-6 mb-1">
              ...
              <?php  $industryArray = explode(",",$this->gfa_model->getMentorDetails($email)[0]['Industry']); ?>
             ...
             <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">Investment Stage</label>
              <select id="country" name="current_stage" class="select2 form-select">
                  <option value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['Investment_stage'];  ?>"><?php echo $this->gfa_model->getMentorDetails($email)[0]['Investment_stage'];  ?></option>
             <?php	$rowIndustry = $this->admin_model->implementationStage();  foreach($rowIndustry as $rowArrayIndustry){  ?>
            ...
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">Investment Interest</label>
              <select id="country" name="Implementation_stage" class="select2 form-select">
                  <option value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['Investment_Interest'];  ?>"><?php echo $this->gfa_model->getMentorDetails($email)[0]['Investment_Interest'];  ?></option>
             ...
             <div class="col-12 col-sm-6 mb-1">
              ...
              <input type="number" class="form-control" id="accountAddress" name="Min_Cheque" placeholder="Funding to raise" value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['Min_Cheque'];  ?>" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">Maximum Cheque</label>
              <input type="number" class="form-control" id="accountAddress" name="Max_Cheque" placeholder="Funding to raise" value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['Max_Cheque'];  ?>" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">Meeting Frequency</label>
              <input type="number" class="form-control" id="accountAddress" name="Meeting_Frequency" placeholder="Meeting Frequency" value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['Meeting_Frequency'];  ?>" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">No of Hours to Mentor</label>
              <input type="number" class="form-control" id="accountAddress" name="Hours_Req" placeholder="No of Hours to Mentor" value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['Hours_Req'];  ?>" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">Highest Qualification</label>
              <input type="number" class="form-control" id="accountAddress" name="Qualification" placeholder="Highest Qualification" value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['Qualification'];  ?>" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">Experience as a mentor</label>
              <input type="number" class="form-control" id="accountAddress" name="No_Startup" placeholder="Experience as a mentor" value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['Exp'];  ?>" />
            </div>
           <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">Website</label>
              <input type="text" class="form-control" id="accountAddress" name="website" placeholder="website" value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['Website'];  ?>" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">LinkedIn Profile</label>
              <input type="text" class="form-control" id="accountAddress" name="linkedIn" placeholder="LinkedIn Profile ID" value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['LinkedIn'];  ?>" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">Facebook Profile</label>
              <input type="text" class="form-control" id="accountAddress" name="facebook" placeholder="Facebook Profile ID" value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['Facebook'];  ?>" />
            </div>
             <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">WhatsApp Id</label>
              <input type="text" class="form-control" id="accountAddress" name="Networth" placeholder="WhatsApp_Id" value="<?php echo $this->gfa_model->getMentorDetails($email)[0]['WhatsApp_Id'];  ?>" />
            </div>
              <div class="col-12 col-sm-6 mb-1">
              ...
              <option value="<?php echo $this->gfa_model->getStartUpDetails($email)[0]['Hear_Us'];  ?>"><?php echo $this->gfa_model->getMentorDetails($email)[0]['Hear_Us'];  ?></option>
              ...
              <label class="form-label" for="normalMultiSelect">What areas you’d like Mentor?</label>
             
              <select id="country" name="mentorship[]" multiple="multiple" class="select2 form-control form-select">
                  <?php  $mentorArray = explode(",",$this->gfa_model->getMentorDetails($email)[0]['Mentorship']); ?>
            ...
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">Tell us a little about your yourself? </label>
              <textarea
           ...
           <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">Mentorship history</label>
              <textarea
                  
                  class="form-control char-textarea"
                  id="textarea-counter"
                  rows="3"
                  placeholder="Mentorship history"
                  style="height: 100px"
    ...
    $.ajax({
     data:formData,
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/mentorProfilepro",
