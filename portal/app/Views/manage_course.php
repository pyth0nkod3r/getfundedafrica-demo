    ...
    <div class="app-content content ">
      ...
      <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Manage Course Posted</h2>
                <div class="breadcrumb-wrapper">
                  <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>gfa/perks">All Courses</a>-->
                  <!--  </li>-->
                    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>gfa/add_course">+ Add Course </a>
                    </li>
          ...
          <div class="table-responsive">
            ...
            <table class="table tablemanager">
              ...
              <tbody class="loadCorperate">
                ...
                $row = $this->gfa_model->getAllCourses();
                $n = 1;
               ...
               <a href="<?php echo base_url()?>gfa/course/<?php echo $rowArray['id']; ?>/<?php echo $rowArray['coursetitle'] ?>" ><i data-feather="external-link" class="text-success font-medium-1"></i>View</a> | 
               <a href="<?php echo base_url()?>gfa/add_course_section_extra/<?php echo $rowArray['id']; ?>"><i data-feather="plus" class="text-success font-medium-1"></i>Section Lesson</a> | 
               <a href="<?php echo base_url()?>gfa/edit_course/<?php echo $rowArray['id']; ?>" ><i data-feather="edit" class="text-success font-medium-1"></i>Edit</a> | 
               <a href="#" alt="delete Course" class="deletebtn"><i data-feather="trash" class="text-success font-medium-1"></i>Delete<span style="display: none;"><?php echo $rowArray['id'] ?></span></a>  
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <div class="fw-bolder"><?php echo $rowArray['learningpath'] ?></div>
                      </div>
                    </div>
                  </td>
                <td>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <div class="fw-bolder"><?php echo $rowArray['coursetitle'] ?></div>
                      </div>
                    </div>
                  </td>
                 
                  <td> <?php echo $rowArray['duration'] ?> </td>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <span>Lesson[<?php echo $this->gfa_model->countLesson($rowArray['id']) ?>]</span>
                    </div>
                  </td>
...
tempInput.remove();
  ...
  $(this).closest('tr').remove();
    ...
    $.ajax({
     data:{id:id},
     type: "POST",
     url: "<?php echo base_url("gfa/deleteCourse"); ?>",
