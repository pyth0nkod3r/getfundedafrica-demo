...
<br><br></center>
    ...
    <div class="card">
      <div class="card-header border-bottom">
        ...
        <h4 class="card-title">Startup/SME Registration:</h4><br>
 ...
 <option value="Aggregation of data and gaining new insights">Aggregation of data and gaining new insights</option>
    ...
    <option value="Acquisition">Acquisition</option>
            ...
            <div class="col-12">
              ...
              <input type="hidden" class="form-control sub" name="sub" placeholder="subscription" value="<?php echo $this->session->userdata('sub');  ?>" />
    ...
    e.preventDefault();
     ...
     data:startupInfo,
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/startupSubPro",
	 ...
	 beforeSend:function() {$(".saveBtn").html('Saving Profile...');$(".saveBtn").prop('disabled', true);},
      success: function(data) {
       //
       if(subFree =='Free'){
		  $(".displayAction").html("Thank you for subscribing for Free the limited choice! Please check your email for more details");  
       }else{
          
          window.open("<?php echo base_url(); ?>gfa/promo_checkout", "_self"); 
       }
	   $(".saveBtn").html('Saved');  
