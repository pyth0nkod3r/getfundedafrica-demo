...
<script>
    ...
    document.getElementById('backButton').addEventListener('click', function() {
        window.history.back();
         ...
         <li class="nav-item dropdown dropdown-notification me-30 ">
              <a class="nav-link" href="#" data-bs-toggle="dropdown"><i class="ficon" data-feather="bell"></i><span class="badge rounded-pill bg-danger badge-up totalNotify">0</span></a>
          ...
          <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">
                 ...
                 //     if($account_type=='startup' || $account_type=='individual'){
                  echo ucwords($rowArrayStartup[0]['Primary_Contact_Name']);
                  //    }
                ...
                ?>  
                  ...
                  <?php  if(empty($account_type)){ echo "TIME OUT"; }else { echo strtoupper($rowArrayStartup[0]['Startup_Company_Name']); } ?>
              <?php  
      ...
      ?>
            ...
            <a class="dropdown-item" href="<?php echo base_url('gfa/invite_users'); ?>"><i class="me-50" data-feather="credit-card"></i>Inviter un <br>  &nbsp; &nbsp; &nbsp;  utilisateur<?php //echo lang('translation.Invite User') ?></a>
              <div class="dropdown-divider"></div><!--<a class="dropdown-item" href="#"><i class="me-50" data-feather="settings"></i> Settings</a>-->
              <a class="dropdown-item" href="<?php echo base_url('gfa/subscribe'); ?>"><i class="me-50" data-feather="credit-card"></i><?php echo lang('translation.Subscription') ?></a>
              <a class="dropdown-item" href="<?php echo base_url('gfa/billing'); ?>"><i class="me-50" data-feather="credit-card"></i><?php echo lang('translation.Billing') ?></a>
