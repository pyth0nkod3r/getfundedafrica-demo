  ...
  <div class="modal-dialog modal-dialog-centered modal-edit-user">
    ...
    <script src="<?php echo base_url(); ?>assets/app-assets/vendors/js/tables/datatable/responsive.bootstrap5.js"></script>
     <script src="<?php echo base_url(); ?>assets/app-assets/vendors/js/forms/select/select2.full.min.js"></script>
      <script src="<?php echo base_url(); ?>assets/app-assets/js/scripts/forms/form-select2.min.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <script src="<?php echo base_url(); ?>assets/app-assets/js/scripts/pages/page-pricing.min.js"></script>
    ...
    <!-- END: Page JS-->
     ...
     <!-- BEGIN: Page JS-->
    <script src="<?php echo base_url(); ?>assets/app-assets/js/scripts/pages/app-calendar-events.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/app-assets/js/scripts/pages/app-calendar.min.js"></script>
    <!-- END: Page JS-->
      <script src="<?php echo base_url(); ?>assets/app-assets/js/scripts/pages/dashboard-ecommerce.min.js"></script>
    ...
    <!-- BEGIN: Page Vendor JS-->
    <script src="<?php echo base_url(); ?>assets/app-assets/vendors/js/extensions/jstree.min.js"></script>
    <!-- END: Page Vendor JS-->


    <!-- BEGIN: Page JS-->
    <script src="<?php echo base_url(); ?>assets/app-assets/js/scripts/pages/app-file-manager.min.js"></script>
    <!-- END: Page JS-->
