    ...
    <div class="app-content content ">
      ...
      <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Manage Course Category</h2>
                <div class="breadcrumb-wrapper">
                  <ol class="breadcrumb">
                  
                    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>gfa/add_course_category">+ Add Course Category </a>
                    </li>
          ...
          <div class="table-responsive">
            ...
            <table class="table tablemanager">
              ...
              <tbody class="loadCorperate">
                ...
                $row = $this->gfa_model->getAllCourseCategory();
                $n = 1;
               ...
               <a href="<?php echo base_url()?>gfa/edit_course_category/<?php echo $rowArray['id']; ?>" ><i data-feather="edit" class="text-success font-medium-1"></i>Edit</a> | 
...
tempInput.remove();
  ...
  $(this).closest('tr').remove();
    ...
    $.ajax({
     data:{id:id},
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/deleteCourseCategory",
