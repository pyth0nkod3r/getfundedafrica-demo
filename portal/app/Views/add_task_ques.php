        ...
        <?php $getCoFoundersJson =  $this->gfa_model->getStartUpDetails($email)[0]['Co_Founder_Info'];
            ...
            <div data-repeater-list="invoice">
                ...
                <div class="row d-flex align-items-end">
                  <div class="col-md-12 col-12">
                    <div class="mb-1">
                      ...
                      <textarea class="form-control char-textarea" rows="3" style="height: 100px" name="question[]"></textarea>
              ...
              <div class="mb-1">
                   ...
                   <textarea class="form-control char-textarea" rows="3" style="height: 100px" name="ans_id[]"></textarea>
...
$(".founderForm").submit(function(e) {
    ...
    $.ajax({
     data:formData,
     type: "POST",
     url: "<?php echo base_url("gfa/addquestaskpro"); ?>",
