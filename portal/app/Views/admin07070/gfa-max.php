        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title">GFA MAX / Videos</h3>
            </div>
            <!-- /.box-header -->
            
            <div class="box-body">
                <!--<a href="<?php echo base_url(); ?>admin/add_cohort_participant/Microsoft" class="btn btn-info pull-right">+ Add Cohort Particpant</a>-->
                <form class="pull-right" method="POST" action="<?php echo base_url(); ?>download/export/onboard_individual/interest_gfamax">
                <input type="hidden" name="column_value" value="gfa-max" >
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php 
				$n = 1;
				$row = $this->admin_model->getAllGfaMax();  foreach($row as $rowArray){  
