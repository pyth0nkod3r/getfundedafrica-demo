     ...
     <div class="row displayForm">
        <div class="col-md-6">
          ...
          <div class="box box-info">
            ...
            <?php $rowArray =   $this->admin_model->getCreditRedeemById($id) ?>
            <div class="box-body">
              <!-- Color Picker -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <input type="text" name="Cohort_Program" class="form-control" disabled value="$<?php echo $rowArray[0]['Credit'] ; ?>">
                </div>
                    <input type="hidden" name="id"  value="<?php echo $id ; ?>">
                    <input type="hidden" name="Email"  value="<?php echo $rowArray[0]['Email'] ; ?>">
                    <input type="hidden" name="Credit"  value="<?php echo $rowArray[0]['Credit'] ; ?>">
              
                <div class="form-group">
                  <label for="inputPassword3" class="control-label">Send Credit Info</label>

                  <div class="col-sm-12">
                     <textarea id="editor12" name="More_Info" rows="5" cols="50">
...
<script>
 ...
 $("#sendCreditForm").submit(function(e) {
    ...
    $.ajax({
     data:CreditForm,
     type: "POST",
     url: "<?php echo base_url(); ?>admin/sendcreditpro",
	 error:function() {$(".saveCohortForm").html('Error')},
	 beforeSend:function() {$(".saveCohortForm").html('Submitting Credit...')},
      success: function(data) {
        
		//if(data==1){
		$(".saveCohortForm").html('Credit Info Sent');
