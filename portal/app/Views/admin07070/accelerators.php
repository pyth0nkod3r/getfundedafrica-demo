        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">ACCELERATOR</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <form class="pull-right" method="POST" action="<?php echo base_url(); ?>download/export/Accelerator/">
               ...
               <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <th>Email</th>
				  <th>Implementation_Stage_Focus</th>
				  <th>Phone</th>
                  <th>Country</th>
				...
				$row = $this->admin_model->getAllAccelerator();  foreach($row as $rowArray){  
				...
				?>
                  <tr>
                    ...
                    <?php echo $rowArray['Accelerator_Name'] ; ?>
                    </td>
                    ...
                    <td>
                    <?php echo $rowArray['Implementation_Stage_Focus']; ?>
                    </td>
                    <td>
                    <?php echo $rowArray['Phone']; ?>
                    </td>
                    <td>
