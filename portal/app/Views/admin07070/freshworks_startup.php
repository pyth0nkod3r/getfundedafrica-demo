        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">FRESHWORKS WEBINARS REGISTERED</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               <table id="example1" class="table table-bordered table-striped">
				...
				$n= 1;
				$row = $this->admin_model->getAllStartUpFreshworks();  foreach($row as $rowArray){  
				...
				?>
                  <tr>
                   ...
                   <td><?php echo date('d-m-Y', strtotime($rowArray['date'])); ?></td>
