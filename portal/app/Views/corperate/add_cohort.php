        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Add Cohort</h2>
  ...
  <div class="row">
    <!-- Blog -->
      ...
      <div class="card">
          ...
          <form action="#" id="#EventForm" class="form EventForm cohortForm" enctype="multipart/form-data">
            <div class="row">
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" name="Title" class="form-control" required placeholder="Title of Cohort e.g DCDT, MICROSOFT" />
                </div>
              </div>
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" class="form-control" name="Short_Desc" placeholder="Short Description of Cohort" />
                </div>
              </div>
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" class="form-control" name="Cohort_Program" placeholder="Location" />
                </div>
              </div>
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" class="form-control" name="Cohort_Type" placeholder="Cohort Session" />
                </div>
              </div>
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" class="form-control" name="Cohort_Duration" placeholder="Cohort Duration" />
                </div>
              </div>
        ...
        <div class="col-md-6 mb-1">
         ...
         <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <select  class="form-control" name="Ticket" placeholder="Payment Type">
    ...
    <option value="ZWB" label="Zimbabwean bonds">ZWB</option>
              ...
              <div class="col-sm-6 col-12">
                ...
                <div class="mb-2">
                  <input type="file" name="file[]" class="form-control" required placeholder="Cohort Banner" />
                </div>
              </div>
              <div class="col-sm-6 col-12">
                  <label>Cohort Partner Logo </label>
                <div class="mb-2">
                  <input type="file" name="file[]" class="form-control" required placeholder="Cohort Partner Logo" />
                </div>
              </div>
              <div class="col-sm-6 col-12">
                <div class="mb-2">
              ...
              <div class="col-12">
                <textarea class="form-control mb-2" name="Main_Desc" required rows="4" placeholder="About the Cohort"></textarea>
              </div>
             
              <div class="col-12">
                <button type="submit" class="btn btn-primary cohortBtn">Post Cohort</button><span class="saveCohortForm"></span>
              </div>
            </div>
          </form>
        </div>
    ...
    $.ajax({
     data:formData,
     type: "POST",
     url: "<?php echo base_url("gfa/cohort_upload"); ?>",
...
<!--/ Blog Detail -->
  ...
  <div class="blog-recent-posts mt-3">
    <h6 class="section-label">Your Posted Event</h6>
    <div class="mt-75">
<?php 
