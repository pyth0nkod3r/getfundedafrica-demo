      ...
      <div class="card" id="info">
        <div class="card-body">
          ...
          <div class="d-flex mt-2">
            ...
            <div class="d-flex align-item-center justify-content-between flex-grow-1">
              <div class="me-1">
                <p class="fw-bolder mb-0">Current Job Role/Title</p>
                <span><?php echo $rowArrayExt[0]['current_job']; ?></span>
              </div>
              <!-- <div class="mt-50 mt-sm-0">
                <div class="form-check form-switch form-check-primary">
          ...
          <div class="d-flex mt-2">
            ...
            <div class="d-flex align-item-center justify-content-between flex-grow-1">
              <div class="me-1">
                <p class="fw-bolder mb-0">Years of Professional Experience</p>
                <span><?php echo $rowArrayExt[0]['job_years_exp']; ?></span>
              </div>
              <!-- <div class="mt-50 mt-sm-0">
                <div class="form-check form-switch form-check-primary">
                  <input type="checkbox" class="form-check-input" id="checkboxSlack" />
          ...
          <div class="d-flex mt-2">
            ...
            <div class="d-flex align-item-center justify-content-between flex-grow-1">
              <div class="me-1">
                <p class="fw-bolder mb-0">Current Industry/Sector</p>
                <span><?php echo $rowArrayExt[0]['current_industry']; ?></span>
              </div>
           ...
           <div class="d-flex mt-2">
            ...
            <div class="d-flex align-item-center justify-content-between flex-grow-1">
              <div class="me-1">
                <p class="fw-bolder mb-0">Professional Interests</p>
                <span><?php echo $rowArrayExt[0]['professional_interest']; ?></span>
              </div>
          ...
          <div class="d-flex mt-2">
            ...
            <div class="d-flex align-item-center justify-content-between flex-grow-1">
              <div class="me-1">
                <p class="fw-bolder mb-0">Why Do You Want to Take Part in this Program?</p>
                <span><?php echo $rowArrayExt[0]['program_reason']; ?></span>
              </div>
              <!-- <div class="mt-50 mt-sm-0">
                <div class="form-check form-switch form-check-primary">
          ...
          <div class="d-flex mt-2">
            ...
            <div class="d-flex align-item-center justify-content-between flex-grow-1">
              <div class="me-1">
                <p class="fw-bolder mb-0">What Industry or Sector Do You Want to Work In</p>
                <span><?php echo $rowArrayExt[0]['industry_interest']; ?></span>
              </div>
              <!-- <div class="mt-50 mt-sm-0">
                <div class="form-check form-switch form-check-primary">
                  <input type="checkbox" class="form-check-input" id="checkboxAsana" />
          ...
          <div class="d-flex mt-2">
            ...
            <div class="d-flex align-item-center justify-content-between flex-grow-1">
              <div class="me-1">
                <p class="fw-bolder mb-0">Professional Goals for the Next 5years</p>
                <span><?php echo $rowArrayExt[0]['professional_goals']; ?></span>
              </div>
              <!-- <div class="mt-50 mt-sm-0">
                <div class="form-check form-switch form-check-primary">
                  <input type="checkbox" class="form-check-input" id="checkboxAsana" />
          ...
          <div class="d-flex mt-2">
            ...
            <div class="d-flex align-item-center justify-content-between flex-grow-1">
              <div class="me-1">
                <p class="fw-bolder mb-0">How Would You Rate Your Proficiency in Using Basic Office Software and Online Collaboration Tools (e.g., Word, Excel, PowerPoint, Teams, Zoom, Google Meet, etc.)?</p>
                <span><?php //echo $rowArrayExt[0]['NoOfEmployees']; ?></span>
              </div>
              <!-- <div class="mt-50 mt-sm-0">
                <div class="form-check form-switch form-check-primary">
                  <input type="checkbox" class="form-check-input" id="checkboxAsana" />
          ...
          <div class="d-flex mt-2">
            ...
            <div class="d-flex align-item-center justify-content-between flex-grow-1">
              <div class="me-1">
                <p class="fw-bolder mb-0">Which of these Technology Skills Interest You?</p>
                <span><?php echo $rowArrayExt[0]['tech_skills_interest']; ?></span>
              </div>
              <!-- <div class="mt-50 mt-sm-0">
                <div class="form-check form-switch form-check-primary">
                  <input type="checkbox" class="form-check-input" id="checkboxAsana" />
