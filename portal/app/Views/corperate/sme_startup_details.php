      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="info-container">
            ...
            <a href="<?php echo base_url(); ?>gfa/notify_inbox" class="btn btn-primary btn-sm" actionMsg="Message">Message</a>
            <a href="<?php echo base_url(); ?>calendar/index" class="btn btn-secondary btn-sm" actionMsg="Schedule meeting">Schedule meeting</a>
            <a href="<?php echo base_url(); ?>chat/index" class="btn btn-success btn-sm" actionMsg="Chat">Chat</a>
...
<script>
    ...
    $.ajax({
     data:formData,
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/callSmeToSme",
	 error:function() {$(".displayAction").html('Error')},
