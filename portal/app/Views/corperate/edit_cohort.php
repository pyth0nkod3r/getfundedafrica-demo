        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Edit  Cohort</h2>
                <div class="breadcrumb-wrapper">
                  <ol class="breadcrumb">
                    
                    <li class="breadcrumb-item"><a href="<?php echo base_url("gfa/manage_cohort"); ?>">Manage Cohort</a>
                    </li>
...
<div class="blog-detail-wrapper">
  <div class="row">
    <!-- Blog -->
      ...
      <div class="card">
        <div class="card-body">
        <?php  $rowArray = $this->admin_model->getAllCohortEventById($id);  ?>
          <form action="#" id="#EventForm" class="form EventForm cohortForm" enctype="multipart/form-data">
            <div class="row">
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" name="Title" class="form-control" required placeholder="Title of Cohort e.g DCDT, MICROSOFT" value="<?php echo $rowArray[0]['Title']  ?>" />
                </div>
              </div>
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" class="form-control" name="Short_Desc" placeholder="Short Description of Cohort" value="<?php echo $rowArray[0]['Short_Desc']  ?>" />
                </div>
              </div>
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" class="form-control" name="Cohort_Program" placeholder="Location" value="<?php echo $rowArray[0]['Cohort_Program']  ?>" />
                </div>
              </div>
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" class="form-control" name="Cohort_Type" placeholder="Cohort Session" value="<?php echo $rowArray[0]['Cohort_Type']  ?>" />
                </div>
              </div>
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" class="form-control" name="Cohort_Duration" placeholder="Cohort Duration" value="<?php echo $rowArray[0]['Cohort_Duration']  ?>" />
                </div>
              </div>
          ...
          <input
            ...
            value="<?php echo $rowArray[0]['Date']  ?>"
          />
        </div>
        
        <div class="col-md-6 mb-1">
          <label class="form-label" for="fp-date-time">Demo Date</label>
          <input
            type="text"
            id="fp-date-time"
            name="Demo_Date"
            class="form-control flatpickr-date-time"
            placeholder="YYYY-MM-DD HH:MM"
            value="<?php echo $rowArray[0]['Demo_Date']  ?>"
          />
         ...
         <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <select  class="form-control" name="Ticket" placeholder="Payment Type" value="<?php echo $rowArray[0]['Fee']  ?>">
                  <option value="<?php echo $rowArray[0]['Ticket']  ?>"><?php echo $rowArray[0]['Ticket']  ?></option>    
               ...
               <div class="col-sm-6 col-12">
                <div class="mb-2">
                  ...
                  <option value="<?php echo $rowArray[0]['Currency']  ?>"><?php echo $rowArray[0]['Currency']  ?></option>   
    ...
    <option value="ZWB" label="Zimbabwean bonds">ZWB</option>
               ...
               <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" class="form-control" name="Fee" placeholder="Fee" value="<?php echo $rowArray[0]['Fee']  ?>" />
                </div>
              </div>
              ...
              <div class="col-sm-6 col-12">
                ...
                <div class="mb-2">
                  <input type="file" name="file[]" class="form-control"  placeholder="Company Logo" />
                  <input type="hidden" name="Logo" class="form-control"  placeholder="Fee" value="<?php echo $rowArray[0]['Logo']  ?>">
                </div>
              </div>
              <div class="col-sm-6 col-12">
                  <label>Cohort Banner </label>
                <div class="mb-2">
                  <input type="file" name="file[]" class="form-control"  placeholder="Cohort Banner" />
                  <input type="hidden" name="Banner" class="form-control"  placeholder="Fee" value="<?php echo $rowArray[0]['Banner']  ?>">
                  
                </div>
              </div>
              <div class="col-sm-6 col-12">
                  <label>Cohort Partner Logo </label>
                <div class="mb-2">
                  <input type="file" name="file[]" class="form-control"  placeholder="Cohort Partner Logo" />
                  <input type="hidden" name="Partner_logo" class="form-control"  placeholder="Fee" value="<?php echo $rowArray[0]['Partner_logo']  ?>">
                </div>
              </div>
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" class="form-control" name="Videourl" placeholder="Video Url (youtube, vimeo e.t.c" value='<?php echo $rowArray[0]['Videourl']  ?>' />
                </div>
              </div>
              
              
              <div class="col-12">
                <textarea class="form-control mb-2" name="Main_Desc" required rows="4" placeholder="About the Cohort"><?php echo  $rowArray[0]['Main_Desc']  ?></textarea>
              </div>
              <input type="hidden" name="id" class="form-control"  value="<?php echo $id  ?>">
              <div class="col-12">
                <button type="submit" class="btn btn-primary cohortBtn">Update Cohort</button><span class="saveCohortForm"></span>
              </div>
            </div>
          </form>
        </div>
    ...
    $.ajax({
     data:formData,
     type: "POST",
     url: "<?php echo base_url("gfa/update_cohort_upload"); ?>",
	 error:function() {$(".saveCohortForm").html('Error')},
	 beforeSend:function() {$(".saveCohortForm").html('Submiting...')},
	 processData: false,
    contentType: false,
...
<!--/ Blog Detail -->
  ...
  <div class="blog-recent-posts mt-3">
    <h6 class="section-label">Your Posted Cohort</h6>
    <div class="mt-75">
<?php 

$row =  $this->gfa_model->getEvent($email); foreach($row as $rowStoryArray){ ?>
      <div class="d-flex mb-2">
        <a href="<?php echo base_url("gfa/event/")?><?php echo $rowStoryArray['title']; ?>" class="me-2">
          <img
            class="rounded"
        ...
        <div class="blog-info">
          <h6 class="blog-recent-post-title">
            <a href="<?php echo base_url("gfa/event/")?><?php echo $rowStoryArray['title']; ?>" class="text-body-heading"><?php echo $rowStoryArray['title'] ?></a>
          </h6>
          <div class="text-muted mb-0"><?php echo date('M d Y', strtotime($rowStoryArray['time_submit'])) ?> | <?php echo $rowStoryArray['status']; ?> </div>
          <div class="text-muted mb-0"><a href="<?php echo base_url("gfa/events/")?><?php echo $rowStoryArray['title']; ?>">View</a> | <a href="<?php echo base_url()?>gfa/edit_event/<?php echo $rowStoryArray['event_id']; ?>">Edit</a> | <a href="">Delete</a>  </div>
        </div>
      </div>
