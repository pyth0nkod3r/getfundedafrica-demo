...
<!--The size of cheques the investor writes -->
  ...
  <div class="row">
    ...
    <div class="col-xl-9 col-lg-5 col-md-5 order-1 order-md-0">
      <!-- User Card -->
      <?php	
                $getPartner = $this->gfa_model->getAllPartnerById($id);
                $startupArray = $this->admin_model->getAllStartUpNByEmail($email);
                $rowArray = $this->admin_model->getAllStartUpNById($startupArray[0]['id']); 
                $row = $this->admin_model->getAllCorperateByEmail($getPartner[0]['email']);
                $investorArray = $this->gfa_model->getInvestorDetails($getPartner[0]['email']);
                $mentorArray = $this->gfa_model->getMentorDetails($getPartner[0]['email']);
                $acceleratorArray = $this->gfa_model->getAcceleratorDetails($getPartner[0]['email']);
          ...
          <div class="user-avatar-section">
            <div class="d-flex align-items-center flex-column">
              ...
              <div class="user-info text-center">
                ...
                <span class="badge bg-light-secondary"><?php  echo $investorArray[0]['Contact_Name']; echo $mentorArray[0]['Mentor_name']; echo $acceleratorArray[0]['Contact_Name'] ; echo $row[0]['Corporate_Name']; ?>
          ...
          <div class="info-container">
            <ul class="list-unstyled">
              ...
              <li class="mb-75">
                ...
                <span><?php echo $getPartner[0]['email']; ?></span>
              </li>
              <li class="mb-75">
                <span class="fw-bolder me-25"> Company:</span>
                <span><?php  echo $investorArray[0]['Investor_Name']; echo $mentorArray[0]['Company']; echo $acceleratorArray[0]['Accelerator_Name'] ; echo $row[0]['Corporate_Name']; ?></span>
              </li>
              <li class="mb-75">
            ...
            <!--  <a href="<?php //echo base_url(); ?>gfa/schedule/startup/<?php //echo $row[0]['Corporate_ID']  ?>" class="btn btn-primary me-1" >-->
            <!--    Schedule Meeting-->
            <!--  </a>-->
