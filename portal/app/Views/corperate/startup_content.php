...
<i data-feather="list" class="user-timeline-title-icon"></i>
            <h4 class="card-title">Startups Story Content</h4>
        ...
        <div class="card-body p-0">
          ...
          <div class="table-responsive">
            <table class="table">
              ...
              $row = $this->admin_model->StoryPostByStartup($rowArrays[0]['Event']); 
              //  $getInvestorArray = $this->admin_model->getAllInvestorByEmail($rowR[0]['email']) 
				foreach($row as $rowArray){  
          $startupArray = $this->admin_model->getAllStartUpNByEmail($rowArray['email']);
                ?> 
                <tr>
                <td class="text-nowrap">
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                  <a href="<?php echo base_url("gfa/tellyourstory/"); ?><?php echo $rowArray['title']; ?>" >   <span class="fw-bolder me-1">Details</span>
