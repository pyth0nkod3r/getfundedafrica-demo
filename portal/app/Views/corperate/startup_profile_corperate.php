  ...
  <div class="col-12">
      ...
      <center><br>
<!--<img src="https://getfundedafrica.com/portal/assets/images/freshworks.png">-->
<br><br></center>
    <!-- profile -->
    <div class="card">
      <div class="card-header border-bottom">
        
        <h4 class="card-title">Startups Registration:</h4><br>
...
<option value="Zimbabwe">Zimbabwe</option> 
            ...
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">No of Workers</label>
              <!-- <label class="form-label" for="accountFirstName" style="color:#ff0000;">* Linkedin Profile</label>-->
              <input type="number" class="form-control" id="accountAddress" name="NoOfEmployees" placeholder="No of Employees" value="" />
              <input type="hidden" class="form-control" id="accountAddress" name="Hear_Us" placeholder="LinkedIn Profile ID" value="GFA & DCDT" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
...
<option value="Accessing new markets/customers">Accessing new markets/customers</option>
 ...
 <option value="Aggregation of data and gaining new insights">Aggregation of data and gaining new insights</option>
    ...
    e.preventDefault();
     ...
     data:startupInfo,
     type: "POST",
     url: "<?php echo base_url("gfa/startupProfileCorperatePro"); ?>",
     error:function() {$(".displayAction").html('Error saving data');},
	 beforeSend:function() {$(".saveBtn").html('Saving Profile...');},
      success: function(data) {
       //
		  $(".displayAction").html("Successful Registration! Please let the SME check his/her email for more details");  
	   $(".saveBtn").html('Saved');  
