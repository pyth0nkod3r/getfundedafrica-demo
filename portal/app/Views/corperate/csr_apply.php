...
<i data-feather="list" class="user-timeline-title-icon"></i>
            <h4 class="card-title">CSR Participants</h4>
          ...
          <div class="table-responsive">
            ...
            <table class="table">
              ...
              <tbody class="loadCorperate">
                ...
                <?php
                 $row = $this->admin_model->applyCSR($id);
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <div class="font-small-2 text-muted"> <?php echo $this->admin_model->getAllStartUpNByEmail($rowArray['email'])[0]['Startup_Company_Name'] ; ?>yr(s)</div>
                      </div>
                    </div>
                  </td>
                  <td>
