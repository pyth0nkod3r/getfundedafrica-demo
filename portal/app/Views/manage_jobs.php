...
<i data-feather="list" class="user-timeline-title-icon"></i>
            <h4 class="card-title">Manage Job Posted</h4>
            ...
            <table class="table">
              ...
              <!--</div>-->
                ...
                <tr>
                  <th>Job Title </th>
                  <th>Ending Date</th>
                  <th class="locationChange">Applicants</th>
              ...
              <tbody class="loadCorperate">
                ...
                $row = $this->gfa_model->getAllJobsByEmail($email);
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <div class="fw-bolder"><?php echo $rowArray['job_title'] ?></div>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <span><?php echo str_replace("?","",$rowArray['time_end']); ?></span>
                    </div>
                  </td>
                  <td class="text-nowrap">
                    <div class="d-flex flex-column">
                       <a href="<?php echo base_url(); ?>gfa/hire/<?php echo $rowArray['id']; ?>" >   <span class="fw-bolder me-1">Check [<?php echo $this->gfa_model->countJobApplicant($rowArray['id']); ?>]</span></a>
               ...
               <a href="<?php echo base_url()?>gfa/job_details/<?php echo $rowArray['id']; ?>" ><i data-feather="external-link" class="text-success font-medium-1"></i></a> | 
               <a href="<?php echo base_url()?>gfa/edit_job/<?php echo $rowArray['id']; ?>" ><i data-feather="edit" class="text-success font-medium-1"></i></a> | 
