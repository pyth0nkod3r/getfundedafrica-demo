        ...
        <div class="card-body">
          ...
          <div class="info-container">
            ...
            <input type="hidden" class="connectEmail" value="<?php echo $row[0]['Email']; ?>" />
             <input type="hidden" class="connectType" value="mentor-startup" />
             <input type="hidden" class="connectMsg" value="Demande de connexion au startup" />
          ...
          <div class="d-flex mt-2">
            ...
            <div class="d-flex align-item-center justify-content-between flex-grow-1">
              <div class="me-1">
                ...
                <span> <?php echo lang("translation.{$row[0]['Revenue']}"); ?> XOF</span>
              </div>
              <!-- <div class="mt-50 mt-sm-0">
                <div class="form-check form-switch form-check-primary">
      ...
      $(function(){
        ...
        $(".connectBtn").click(function() {
                  ...
                  $.ajax({
                      ...
                      type: "POST",
                      url: "<?php echo base_url(); ?>gfa/matchedConnectionAll",
                      error: function() {
                      ...
                      success: function(data) {
                        $(".displayAlert").show();
                          ...
                          $(".displayContent").html('Demande envoyée au startup, vous serez informé de la  réponse.');
                          $('.connectBtn').html("Envoyé à cette startup");
                          $('.connectBtn').prop("disabled", true);
         ...
         <form action="#" id="#EventForm" class="form EventForm" enctype="multipart/form-data">
            ...
            <div class="col-md-12 mb-1">
              ...
              <div class="col-12">
                  <input type="hidden" name="id" class="form-control" value="<?php echo $id ?>" />
                <div class="mb-2">
                  <input type="text" name="subject" class="form-control" placeholder="<?php echo lang('translation.Other subject') ?>" />
                </div>
              </div>
...
<script>
    ...
    $.ajax({
	 ...
	 beforeSend:function() {$(".displayActionDealRoom").html('Requête en cours...'); $(".EventBtnDealRoom").prop('disabled', true);},
	 processData: false,
    contentType: false,
      success: function(data) {
