        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Add Job</h2>
...
<div class="blog-detail-wrapper">
  <div class="row">
        ...
        <div class="card-body">
          <form action="#" id="postJobs" class="form storyForm" enctype="multipart/form-data">
            ...
            <div class="col-sm-6 col-12">
              ...
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" class="form-control" name="job_req" placeholder="Qualification" />
                </div>
              </div>
              
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" name="rem" class="form-control"  placeholder="Remunation" />
                </div>
              </div>
             
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="date" class="form-control" name="time_end" placeholder="Time to end" />
                </div>
              </div>
    ...
    $.ajax({
     data:formData,
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/postjobpro",
...
?>
      ...
      <div class="d-flex mb-2">
        ...
        <div class="blog-info">
          ...
          <div class="text-muted mb-0"><a href="<?php echo base_url()?>gfa/job_details/<?php echo $rowStoryArray['id']; ?>">View</a> | <a href="<?php echo base_url()?>gfa/edit_job/<?php echo $rowStoryArray['id']; ?>">Edit</a> | <a href="">Delete</a> | 
          <a href="<?php echo base_url(); ?>gfa/hire/<?php echo $rowStoryArray['id']; ?>" >   <span class="fw-bolder me-1">Applicants [<?php echo $this->gfa_model->countJobApplicant($rowStoryArray['id']); ?>]</span></a>
          </div>
        </div>
      </div>
