              ...
              <!-- BEGIN: Content-->
    <div class="app-content conten">
      <div class="content-overla"></div>
  ...
  <div class="col-12">
      ...
      <center><br>
<img src="https://getfundedafrica.com/portal/assets/images/adcreative.jpg">
<br><br></center>
    <!-- profile -->
    <div class="card">
      <div class="card-header border-bottom">
        ...
        Organic Strategies For Growth

      </div>
      
      <div class="card-header border-bottom">
        
        <p style="white-space: pre-line"><strong>Topic: </strong> Organic Strategies For Growth</p>
        
        <p style="white-space: pre-line"><strong>Description: </strong> Gaurav Henry is a serial entrepreneur. He was the founder of one of the first international student accommodation portals in the UK. Also, the Co-founder of Hindistandukkan.com, an e-commerce company that is the largest supplier of hand-beaded bridal appliques and dresses in Turkey.
Currently, he heads the growth at one of the most promising AI-based startups based out of Paris- Adcreative.ai backed by Google.

Apart from his work, he is often found networking quenching the thirst for his genuine curiosity from education leaders to talent partners covering top talent at Tier 1 universities. His experience covers a wide variety of initiatives— growth and marketing, learning & development, technology solutions, startup-community mentoring, capital raising, brand building, and business analysis— but generally focuses on behavior-changing initiatives in our race to maximize collective well-being.

Join us for a knowledge-packed session with Gaurav Henry as we dive into the "Organic Strategies For Growth".

Our expert will share insights about the ins and outs of creating and implementing organic strategies that ehances business growth, and you'll have the chance to ask questions.
</p>

        <p style="white-space: pre-line"><strong>Time: </strong> Feb 16, 2023 02:00 PM in West Central Africa (WAT)</p>
...
<!--</form>-->
        ...
        <form class="validate-form mt-2 pt-50 startUpForm" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <select id="country" name="country" class="select form-select">
...
<option value="Zimbabwe">Zimbabwe</option> 
          ...
          <div class="col-12 col-sm-6 mb-1">
              ...
              <input type="text" class="form-control" id="accountAddress" name="LinkedIn" placeholder="LinkedIn Profile ID" value="" />
            </div>
          
            
              <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress">How many people will attend with you?</label>
              <!-- <label class="form-label" for="accountFirstName" style="color:#ff0000;">* How did you hear about us?</label>-->
    ...
    <option value="D2C/B2C">D2C/B2C</option>
                  ...
                  <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountReadiness">Core solutions to corporate</label>
              <!-- <label class="form-label" for="accountReadines" style="color:#ff0000;">* Product / Tech Readines?</label>-->
...
<option value="Accessing new markets/customers">Accessing new markets/customers</option>
 ...
 <option value="Aggregation of data and gaining new insights">Aggregation of data and gaining new insights</option>
    ...
    <option value="Acquisition">Acquisition</option>
            ...
            <div class="col-12">
              <button type="submit" class="btn btn-primary mt-1 me-1 saveBtn">Register</button>
    ...
    e.preventDefault();
     ...
     data:startupInfo,
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/startupWebinarPro",
     error:function() {$(".displayAction").html('Error saving data');},
	 beforeSend:function() {$(".saveBtn").html('Saving Profile...');$(".saveBtn").prop('disabled', true);},
      success: function(data) {
       //
		  $(".displayAction").html("Successful Registration! Please check your email for event details");  
	   $(".saveBtn").html('Saved');  
