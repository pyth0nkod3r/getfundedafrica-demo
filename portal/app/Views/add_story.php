        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-start mb-0"><?php echo lang('translation.Add Story') ?></h2>
...
<div class="blog-detail-wrapper">
  <div class="row">
        ...
        <div class="card-body">
          <form action="#" id="#storyForm" class="form storyForm" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="col-12">
                <textarea class="form-control mb-2" name="story" required rows="4" placeholder="<?php echo lang('translation.Startup Story') ?>"></textarea>
              </div>
             
              <div class="col-12">
                <button type="submit" class="btn btn-primary storyBtn"><?php echo lang('translation.Post Story') ?></button><span class="displayAction"></span>
              </div>
            </div>
          </form>
        </div>
    ...
    $.ajax({
	 ...
	 beforeSend:function() {$(".displayAction").html('Submiting Story...'); $(".storyBtn").prop('disabled', false);},
	 processData: false,
    contentType: false,
