...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url("public/assets/app-assets/vendors/css/forms/wizard/bs-stepper.min.css"); ?>">
	 <link rel="stylesheet" type="text/css" href="<?php echo base_url("public/assets/app-assets/vendors/css/forms/spinner/jquery.bootstrap-touchspin.css"); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("public/assets/app-assets/css/pages/app-ecommerce.min.css"); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("public/assets/app-assets/css/plugins/forms/pickers/form-pickadate.min.css"); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("public/assets/app-assets/css/plugins/forms/form-wizard.min.css"); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("public/assets/app-assets/css/plugins/forms/form-number-input.min.css"); ?>">
    <!-- END: Page CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("public/assets/app-assets/css/pages/app-calendar.min.css"); ?>assets/app-assets/css/pages/app-calendar.min.css">

    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("public/assets/assets/css/style.css"); ?>">
    <!-- END: Custom CSS-->
