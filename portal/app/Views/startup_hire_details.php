  ...
  <div class="row">
    ...
    <div class="col-xl-9 col-lg-5 col-md-5 order-1 order-md-0">
      ...
      <?php	
               ...
               $row = $this->admin_model->getAllCandidateById($id);  
        ...
        <div class="card-body">
          <div class="user-avatar-section">
            <div class="d-flex align-items-center flex-column">
              ...
              <div class="user-info text-center">
                <h4><?php echo $rowArray['fname']." ".$rowArray['lname'] ; ?></h4>
          ...
          <div class="d-flex justify-content-around my-2 pt-75">
            <div class="d-flex align-items-start me-2">
              ...
              <div class="ms-75">
                <h4 class="mb-0"><?php echo $row[0]['yr_exp']; ?></h4>
            ...
            <div class="d-flex align-items-start">
              ...
              <div class="ms-75">
                <h4 class="mb-0"><?php echo $row[0]['gender']; ?></h4>
                <small>Gender</small>
              </div>
            </div>
          </div>
          ...
          <div class="info-container">
            <ul class="list-unstyled">
              ...
              <li class="mb-75">
                ...
                <span><?php echo $row[0]['state'].', '.$row[0]['country']; ?></span>
              </li>
              ...
              <li class="mb-75">
                <span class="fw-bolder me-25">Industry</span>
                <span><?php echo $row[0]['industry']; ?></span>
              </li>
             
              <li class="mb-75">
                <span class="fw-bolder me-25">Resume</span>
                <span><a href="<?php echo $row[0]['file']; ?>">Download CV</a></span>
              </li>
