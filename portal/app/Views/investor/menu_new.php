    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
         <li class=" navigation-header"><span data-i18n="Apps &amp; Pages"><?php echo lang('translation.INVESTORS DEALFLOW') ?></span><i data-feather="more-horizontal"></i>
          ...
          <script>
		     ...
		     $(function(){
		       ...
		       $('.clicklink').click(function(){
		         window.open("<?php echo base_url(); ?>gfa/investor_mentor", "_self");  
		       });  
		       
		        $('.clicklink1').click(function(){
		         window.open("<?php echo base_url(); ?>gfa/startups", "_self");  
		       }); 
		        $('.clicklink2').click(function(){
		         window.open("<?php echo base_url(); ?>gfa/syndicate", "_self");
		 ...
		 <li class=" nav-item active"  style="margin-top:10px;"><a class="d-flex align-items-center clicklink12" href="<?php echo base_url('chat/index'); ?>">
		   ...
		   <i data-feather="user-plus"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Find LP</span></a>
            <ul class="menu-content">
            </ul>
          </li> -->
		   ...
		   <li class=" nav-item active" style="margin-top:10px;"><a class="d-flex align-items-center clicklink2" href="#">
		   <i data-feather="rss"></i><span class="menu-title text-truncate" data-i18n="Dashboards"><?php echo lang('translation.Syndicate a Deal') ?></span></a>
            <ul class="menu-content">
