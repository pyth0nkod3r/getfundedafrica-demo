  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-header border-bottom">
        ...
        <p class="mb-75 me-75"><?php echo lang('translation.Kindly Complete the form below to get an Investor account') ?></p>
      </div>
      <?php  
        ...
        <div class="d-flex">
          ...
          <div class="d-flex align-items-end mt-75 ms-1">
            <div>
              ...
              <p class="mb-0"><?php echo lang('translation.Company logo [Allowed file types: png, jpg, jpeg]') ?></p>
...
<!--</form>-->
        ...
        <div class="col-12 col-sm-6 mb-1">
              ...
              <select id="country" name="country" class="select2 form-select">
                <option value="<?php echo $this->gfa_model->getInvestorDetails($email)[0]['Country'];  ?>">
                  <?php echo $this->gfa_model->getInvestorDetails($email)[0]['Country'];  ?>
                </option>
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <input type="text" class="form-control" id="accountState" required name="state" placeholder="<?php echo lang('translation.State') ?>" value="<?php echo $this->gfa_model->getInvestorDetails($email)[0]['City'];  ?>" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress"><?php echo lang('translation.Address') ?></label>
              <input type="text" class="form-control" id="accountAddress" required name="address" placeholder="<?php echo lang('translation.Your Address') ?>" value="<?php echo $this->gfa_model->getInvestorDetails($email)[0]['Address'];  ?>" />
            </div>
  ...
  <!--<legend>Investment Validation</legend>-->
          <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountOrganization"><?php echo lang('translation.Photo') ?></label>
              <input
                type="file"
                class="form-control"
                id="accountOrganization"
                name="file[]"
                placeholder="<?php echo lang('translation.Investor photo') ?>"
                
              />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountOrganization"><?php echo lang('translation.IDs (Passport, Government Approved Ids and Driving licence)') ?> </label>
              <input
                type="file"
                class="form-control"
                id="accountOrganization"
            ...
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountOrganization"><?php echo lang('translation.Proof of Address') ?></label>
              <input
                type="file"
                class="form-control"
                id="accountOrganization"
          ...
          <div class="col-12 col-sm-6 mb-1">
            ...
            <div class="col-12 col-sm-6 mb-1">
             <label class="form-label" for="country"><?php echo lang('translation.Operation Region') ?></label>
            ...
            <?php $row = $this->admin_model->getAllAfricaRegions();  foreach($row as $getAllAfricaRegions){  ?>
             ...
             <div class="col-12 col-sm-6 mb-1">
              ...
              <input type="number" class="form-control" id="accountAddress" required name="Min_Cheque" placeholder="<?php echo lang('translation.Funding to raise') ?>" value="<?php echo $this->gfa_model->getInvestorDetails($email)[0]['Min_Cheque'];  ?>" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress"><?php echo lang('translation.Maximum Cheque') ?></label>
              <input type="number" class="form-control" id="accountAddress" required name="Max_Cheque" placeholder="<?php echo lang('translation.Funding to raise') ?>" value="<?php echo $this->gfa_model->getInvestorDetails($email)[0]['Max_Cheque'];  ?>" />
            </div>
             <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress"><?php echo lang('translation.Networth') ?></label>
              <input type="text" class="form-control" id="accountAddress" name="Networth" placeholder="<?php echo lang('translation.Networth') ?>" value="<?php echo $this->gfa_model->getInvestorDetails($email)[0]['Networth'];  ?>" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress"><?php echo lang('translation.No of Startups to Fund') ?></label>
              <input type="number" class="form-control" id="accountAddress" name="No_Startup" placeholder="<?php echo lang('translation.No of Startups to Fund') ?>" value="<?php echo $this->gfa_model->getInvestorDetails($email)[0]['No_Startup'];  ?>" />
            </div>
           <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountAddress"><?php echo lang('translation.Website') ?></label>
              <input type="text" class="form-control" id="accountAddress" name="website" placeholder="<?php echo lang('translation.Website') ?>" value="<?php echo $this->gfa_model->getInvestorDetails($email)[0]['Website'];  ?>" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
            ...
            <div class="col-12 col-sm-6 mb-1" style="display:none">
              ...
              <option value="<?php echo $this->gfa_model->getStartUpDetails($email)[0]['Hear_Us'];  ?>"><?php echo $this->gfa_model->getInvestorDetails($email)[0]['Hear_Us'];  ?></option>
                  <option value="Tv/Radio">Tv/Radio</option>
                       <option value="GFA Website">NORA Website</option>
      ...
      <!--      </div>-->
            ...
            <div class="col-12">
              ...
              <span class="displayAction"></span> <span class="displayActionX" style="display:none;"><?php if($account_type == 'investor'){ echo 'Enregistré avec succès!'; }else{ echo 'Successfully Saved! awaiting approval, you will be notified soon.'; } ?> </span>
