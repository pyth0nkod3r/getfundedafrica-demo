          ...
          <div class="row">
            ...
            <div class="col-xl-6 col-md-6 col-12">
              <div class="mb-1">
                ...
                <option value="I am an accredited investor">Je suis un investisseur accrédité</option>  
                <option value="I am not an accredited investor">Je ne suis pas un investisseur accrédité</option>
...
<option value="Between 5 and 20 deals per year">Entre 5 et 20 transactions par an</option> 
<option value="Fewer than 5 deals per year">Moins de 5 transactions par an</option> 
<option value="I only want to run 1 deal now">Je souhaite seulement effectuer 1 transaction pour l'instant</option> 
            ...
            <div class="col-xl-6 col-md-6 col-12">
              <div class="mb-1">
                ...
                <option value="I raised more than $1M">J'ai levé plus de 600 millions XOF</option>  
                <option value="I raised between $100k and $1M">J'ai levé entre 60 millions et 600 millions XOF</option> 
                <option value="I raised less than $100k">J'ai levé moins de 60 millions XOF</option> 
                <option value="I haven't raised money from LPs">Je n'ai pas levé de fonds auprès des LPs</option>
            ...
            <div class="col-xl-6 col-md-6 col-12">
              <div class="mb-1">
                ...
                <option value="I have enough LPs to fill my deals">J'ai suffisamment de LPs pour remplir mes transactions</option>  
                <option value="I have some LPs, not enough to fill my deals">J'ai quelques LPs, mais pas assez pour remplir mes transactions</option> 
                <option value="I don't have any LPs">Je n'ai aucun LP</option>
            ...
            <div class="col-xl-6 col-md-6 col-12">
              <div class="mb-1">
                ...
                <option value="deals">Transactions en syndicat</option>  
                <option value="fund">Fonds en syndicat</option>
