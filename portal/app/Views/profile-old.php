  ...
  <div class="col-12">
    ...
    <div class="card">
      ...
      <div class="card-body py-2 my-25">
         <div class='showProfileError'>
           <?php echo lang('translation.Required field updates are marked with an asterisk (*) and coloured red.') ?> <br>
    <?php if($this->gfa_model->getPhotoUploaded($email)[0]['Photo_name']==""){ ?>
     ...
     <div style="color:#ff0000;">* <?php echo lang('translation.First Name') ?></div>
     <div style="color:#ff0000;">* <?php echo lang('translation.Last Name') ?></div> 
     <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['Phones']==""){ ?>
     <div style="color:#ff0000;">* <?php echo lang('translation.Phone Number') ?></div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['Country']==""){ ?>
     <div style="color:#ff0000;">* <?php echo lang('translation.Your Country') ?></div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['State']==""){ ?>
     <div style="color:#ff0000;">* <?php echo lang('translation.State') ?></div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['Address']==""){ ?>
     <div style="color:#ff0000;">* <?php echo lang('translation.Address') ?></div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['ZipCode']==""){ ?>
     <div style="color:#ff0000;">* <?php echo lang('translation.Zip Code') ?></div>
      <?php }  ?>
    
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['Personal_Linkedin']==""){ ?>
     <div style="color:#ff0000;">* <?php echo lang('translation.Personal LinkedIn Profile') ?></div>
      <?php }  ?>
   
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['Hear_Us']==""){ ?>
     <div style="color:#ff0000;">* <?php echo lang('translation.How did you hear about us?') ?></div>
      <?php }  ?>
      <?php if($this->gfa_model->getStartUpDetails($email)[0]['Gender']==""){ ?>
     <div style="color:#ff0000;">* <?php echo lang('translation.Gender') ?>?</div>
      <?php }  ?>
      <?php if($this->gfa_model->getStartUpDetails($email)[0]['About_Me']==""){ ?>
     <div style="color:#ff0000;">* <?php echo lang('translation.About yourself') ?></div>
      <?php }  ?>
