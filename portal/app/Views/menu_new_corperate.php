    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
      ...
      <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
         ...
         <li class=" nav-item active"  style="margin-top:10px;"><a class="d-flex align-items-center" href="https://getfundedafrica.com/portal/gfa/dashboard">
		   ...
		   <i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Funding</span></a>
            <ul class="menu-content">
              ...
              <li><a class="d-flex align-items-center" href="https://getfundedafrica.com/cohort" target="_blank" alt="Apply for Co-hort"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Analytics">Apply for Co-hort</span></a></li>
              <li><a class="d-flex align-items-center" href="https://getfundedafrica.com/cohort" target="_blank" alt="Self help funding"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">Self help funding</span></a></li>
              <li><a class="d-flex align-items-center" href="<?php echo base_url(); ?>gfa/comingsoon" alt="Data and Insight"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">Data and Insight</span></a></li>
             </ul>
          </li>
 ...
 <?php   // }
     ...
     ?>
		   ...
		   <li class=" nav-item active" style="margin-top:10px;"><a class="d-flex align-items-center" href="#">
		   <i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Venture Building</span></a>
            <ul class="menu-content">
             ...
             <li><a class="d-flex align-items-center" href="#" data-bs-target="#editUser" data-bs-toggle="modal" target="_blank" alt="E-store"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">E-store</span></a>
              </li>
			 
		     <li><a class="d-flex align-items-center" href="<?php echo base_url(); ?>gfa/comingsoon" alt="Partnerships"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">Partnerships</span></a>
              </li>
			  
			   <li><a class="d-flex align-items-center" href="<?php echo base_url(); ?>gfa/comingsoon" alt="Outsourcing"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">Outsourcing</span></a>
              </li>
