        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Add perks Category</h2>
...
<!--            </div>-->
  ...
  <div class="row match-height" bis_skin_checked="1">
          ...
          <div class="row" bis_skin_checked="1">
            <div class="col-12" bis_skin_checked="1">
              ...
              <div class="mb-1" bis_skin_checked="1">
                ...
                <input id="defaultInput" class="form-control form-control-lg" name="category" required type="text" placeholder="Perks Category">
              </div>
              ...
              <div class="col-12">
                <button type="submit" class="btn btn-primary EventBtn mb-2">Add</button><span class="displayAction"></span>
              </div>
            </div>
          </form>
        </div>
    ...
    $.ajax({
     data:formData,
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/addperkscatpro",
	 error:function() {$(".displayAction").html('Error')},
	 beforeSend:function() {$(".displayAction").html('Adding...'); $(".EventBtn").prop('disabled', true);},
	 processData: false,
    contentType: false,
      success: function(data) {
        
	 $(".displayAction").html("Successfully Added");  
	//    $(".saveBtn").html(data); 
       $(".oldPassX").val(data);
