  ...
  <div class="text-center">
    <h1 class="mt-5">Plan tout-en-un</h1>
 
    <p class="mb-2 pb-75">
     Vous obtenez toutes les solutions CIPME dans un seul abonnement abordable.
    </p>
...
<?php  ?>
        ...
        <div class="col-12 col-md-6">
          <div class="card basic-pricing text-center">
            <div class="card-body">
              ...
              <p class="card-text">Le choix de base</p>
  ...
  detectCurrencyAmount(99); }elseif(getlocation()=='South Africa'){ detectCurrencyAmount(254); }else{ detectCurrencyAmount(300);}  ?></span>
                  <sub class="pricing-duration text-body font-medium-1 fw-bold">/mois</sub>
                </div>
                <small class="annual-pricing d-none text-muted"></small>
              </div>
              <ul class="list-group list-group-circle text-start">
               
                 <li class="list-group-item">Toutes les fonctionnalités du plan gratuit</li>
<li class="list-group-item">Accès au cercle d’investisseurs CIPME (plus de 500 millions de dollars en réserve de capital disponible)</li>
<li class="list-group-item">  Accès à des organisations d'entreprises qui peuvent vous soutenir en tant que clients en fournissant des revenus et une validation</li>
<li class="list-group-item">Accès à un nombre illimité de mentors qui peuvent vous aider à guider et à façonner la croissance de votre entreprise et de vos idées</li>
<li class="list-group-item">Bon de 60 XOF pour l'achat de templates riches</li>
<li class="list-group-item">Accès complet à 230 vidéos de cours sur la collecte de fonds</li>
<li class="list-group-item">Outils de génération de leads pour augmenter les revenus</li>
              </ul>
  ...
  detectCurrencyAmount(99); }elseif(getlocation()=='South Africa'){ detectCurrencyAmount(254); }else{ detectCurrencyAmount(300); }  ?>" class="btn w-100 btn-primary mt-2">Mise à niveau</a>
              <?php }else{   ?>
              <button class="btn w-100 btn-outline-success mt-2" disabled >Votre plan actuel</button>
              <?php }  ?>
            </div>
          </div>
        </div>
...
<li class="list-group-item"><?php echo lang('translation.Opportunities to pitch during CIPME Investor Club meetings') ?></li>
...
<li class="list-group-item"><?php echo lang('translation.One-on-one call with a CIPME growth representative') ?></li>
              </ul>
              <?php if(empty($this->gfa_model->getCurrentSub($email,'Business Funding','active'))){
              
              
              ?>
              <a href="<?php echo base_url(); ?>gfa/paypro?onetime=1&package=funding&type=yearly&sub=Business Funding&amt=<?php detectCurrencyAmount(69000); ?>" class="btn w-100 btn-primary mt-2">Mise à niveau</a>
              <?php }else{   ?>
              <button class="btn w-100 btn-outline-success mt-2" disabled >Votre plan actuel</button>
              <?php }  ?>
            </div>
               ...
               <table class="w-full text-left">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5"><strong><?php echo lang('translation.Access to the CIPME investor circle over $500 million in dry powder') ?></strong><br> 
                        </td>
                  ...
                  >
                    ...
                    />
                      ...
                      >
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5"><b><?php echo lang('translation.Access to the CIPME MarketPlace eg apps or web solutions Sell your services and digital products') ?></b>
            <br> </td>
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5 text-center"><div 
                  class="flex h-6 w-6 shrink-0 items-center text-center justify-center rounded-full bg-primary/10 text-primary dark:bg-accent/10 dark:text-accent-light"
                >
             ...
             <tr
               ...
               <td class="sm:px-5 py-3 px-4 whitespace-nowrap"><strong><?php echo lang('translation.Access to research on funding in Africa') ?></strong></td>
               <td class="whitespace-nowrap px-4 py-3 sm:px-5 text-center"><div 
                  class="flex h-6 w-6 shrink-0 items-center text-center justify-center rounded-full bg-primary/10 text-primary dark:bg-accent/10 dark:text-accent-light"
                >
                             <svg
             ...
             <tr
               ...
               <td class="whitespace-nowrap px-4 py-3 sm:px-5"><b><?php echo lang("translation.Opportunities to pitch during CIPME Investor Club meetings") ?>   </b> <br>(<?php echo lang("translation.subject to terms and conditions") ?>)
                  </td>
               <td class="whitespace-nowrap px-4 py-3 sm:px-5 text-center"><div 
                  class="flex h-6 w-6 shrink-0 items-center text-center justify-center rounded-full bg-primary/10 text-primary dark:bg-accent/10 dark:text-accent-light"
                >
             ...
             <tr
               ...
               <td valign="top" class="whitespace-nowrap px-4 py-3 sm:px-5"><b><?php echo lang("translation.Opportunity to be invited on CIPME TV to share your knowledge as a key opinion leader") ?></b> <br>
                 </td>
               <td class="whitespace-nowrap px-4 py-3 sm:px-5 text-center"><div 
                  class="flex h-6 w-6 shrink-0 items-center text-center justify-center rounded-full bg-primary/10 text-primary dark:bg-accent/10 dark:text-accent-light"
                >
             ...
             <tr
               ...
               <td class="whitespace-nowrap px-4 py-3 sm:px-5" valign="top"><strong><?php echo lang("translation.One-on-one call with a CIPME growth representative") ?></strong><br> 
                 </td>
