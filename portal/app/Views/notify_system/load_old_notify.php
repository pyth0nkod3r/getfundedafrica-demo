   ...
   ?>
              <li class="dropdown-menu-header">
                <div class="dropdown-header d-flex">
                  <h4 class="notification-title mb-0 me-auto"><?php echo lang('translation.Notifications') ?></h4>
              ...
              <li class="scrollable-container media-list">
                  ...
                  <div class="list-item d-flex align-items-start">
                    ...
                    <div class="list-item-body flex-grow-1">
                      <p class="media-heading"><span class="fw-bolder"><?php echo lang("translation.{$notifyDetails['subject']}") ?></span></p>
              ...
              <li class="dropdown-menu-footer"><a class="btn btn-primary w-100 userClickedNotify1" href="<?php echo base_url('gfa/notify_inbox'); ?>"><?php echo lang('translation.Read all notifications') ?></a></li>
