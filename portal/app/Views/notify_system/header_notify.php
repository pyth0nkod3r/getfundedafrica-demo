...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('public/assets-new/vendor/libs/quill/katex.css'); ?>" />
<link rel="stylesheet" href="<?php echo base_url('public/assets-new/vendor/libs/quill/editor.css'); ?>" />
<link rel="stylesheet" href="<?php echo base_url('public/assets-new/vendor/libs/select2/select2.css'); ?>" />

    <!-- Page CSS -->
    
<link rel="stylesheet" href="<?php echo base_url('public/assets-new/vendor/css/pages/app-email.css'); ?>" />
