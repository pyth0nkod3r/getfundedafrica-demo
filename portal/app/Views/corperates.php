...
<i data-feather="list" class="user-timeline-title-icon"></i>
            <h4 class="card-title">Recommended Corporate</h4>
...
<!--Options to reach out -->
 <!-- Company Table Card -->
    <div class="col-lg-12 col-12">
         <div class="col-lg-12 text-center mb-2">
          ...
          <!--<a href="#" class="btn btn-secondary btn-next" > Panel Request </a>   <a href="#" class="btn btn-primary btn-next" data-bs-target="#checkInterview" data-bs-toggle="modal"> Request an Interview </a> <a href="<?php echo base_url(); ?>gfa/calendar" class="btn btn-primary btn-next" > Schedule Meeting </a>-->
 ...
 $row = $this->admin_model->MatchCorperateMicrosoftEvent();  
//  }else{
...
//  }
                ...
                if($rowArray['Need_contact_email']==$email){ echo ''; }else{
                ?> 
                ...
                <a href="<?php //echo base_url(); ?>startup_corperate_details/<?php echo $rowArray['Corporate_ID']; ?>" >   <span class="fw-bolder me-1">Connect</span><i data-feather="trending-up" class="text-success font-medium-1"></i></a> | 
                 <a href="<?php echo base_url(); ?>gfa/schedule/startup/<?php echo $rowArray['Corporate_ID']  ?>" >   <span class="fw-bolder me-1">Schedule Meeting</span>
