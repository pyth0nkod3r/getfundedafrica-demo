    ...
    <div class="app-content content ">
      ...
      <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Manage Perks Categories</h2>
                <div class="breadcrumb-wrapper">
                  <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>gfa/perks">All Perks</a>
                    </li>
                    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>gfa/add_perks_category">+ Add Perks Category</a>
                    </li>
          ...
          <div class="table-responsive">
            ...
            <table class="table">
              ...
              <tbody class="loadCorperate">
                ...
                $n = 1;
                $row = $this->gfa_model->getAllPerksCategory();
                ...
                <td>
                    <div class="d-flex align-items-center">
                      ...
                      <span><div class="fw-bolder"><?php echo $n++; ?></div></span>
                    </div>
                  </td>
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <div class="fw-bolder"><?php echo $rowArray['category'] ?></div>
                      </div>
                    </div>
                  </td>
               ...
               <!-- <a href="<?php echo base_url()?>gfa/perks_details/<?php echo $rowArray['id']; ?>" ><i data-feather="external-link" class="text-success font-medium-1"></i>View</a> <?php  if($admin_access=='sub-admin'){ echo '';}else{ ?>|  -->
               <a href="<?php echo base_url()?>gfa/edit_perks_category/<?php echo $rowArray['id']; ?>" ><i data-feather="edit" class="text-success font-medium-1"></i>Edit</a> <?php if($rowArray['status']=='active'){ echo '';}else{ ?> | 
               <a href="#" alt="delete Cohort" class="deletebtn"><i data-feather="trash" class="text-success font-medium-1"></i>Delete<span style="display: none;"><?php echo $rowArray['id'] ?></span></a>
               <?php }  ?>
               <?php }  ?>
                    </div>
                  </td>
...
tempInput.remove();
  ...
  $(this).closest('tr').remove();
    ...
    $.ajax({
     data:{id:id},
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/deletePerksCategory",
