      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="info-container">
            <ul class="list-unstyled">
              <li class="mb-75">
                <span class="fw-bolder me-25"><?php echo lang('translation.Company Name') ?>:</span>
                <span><?php echo $row[0]['Startup_Company_Name']; ?></span>
              </li>
              <li class="mb-75">
                <span class="fw-bolder me-25"><?php echo lang("translation.Manager's Name") ?>:</span>
                <span><?php echo $row[0]['Primary_Contact_Name']; ?></span>
              </li>
            <li class="mb-75">
              ...
              <li class="mb-75">
                <span class="fw-bolder me-25"><?php echo lang('translation.Taxpayer Account Number (DFE)') ?>:</span>
                <span><?php echo $row[0]['Tax_No']; ?></span>
              </li>
              <li class="mb-75">
                <span class="fw-bolder me-25"><?php echo lang('translation.RCCM Number') ?>:</span>
                <span><?php echo $row[0]['CNPS_No']; ?></span>
              </li>
            </ul>
        <div class="demo-inline-spacing justify-content-center">
            ...
            <input type="hidden" class="connectEmail" value="<?php echo $row[0]['Contact_Email']; ?>" />
             <input type="hidden" class="connectType" value="startup-startup" />
             <input type="hidden" class="connectMsg" value="Demande de connexion à la startup" />
          ...
          <div class="d-flex mt-2">
            ...
            <div class="d-flex align-item-center justify-content-between flex-grow-1">
              <div class="me-1">
                ...
                <span><?php echo lang("translation.{$row[0]['Website']}"); ?></span>
              </div>
              <!-- <div class="mt-50 mt-sm-0">
                <div class="form-check form-switch form-check-primary">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body pb-5 px-sm-5 pt-50">
        ...
        <div class="col-12">
             ...
             <input type="hidden" name="conn_name" value="<?php echo $row[0]['Primary_Contact_Name']; ?>" />
             <input type="hidden" name="conn_type" value="startup-startup" />
