      ...
      <div class="email-filters py-2">
        ...
        <ul class="email-filter-folders list-unstyled mb-4">
          <li class="active d-flex justify-content-between" data-target="inbox">
            ...
            <div class="badge bg-label-primary rounded-pill badge-center"><?php echo $this->gfa_model->countNotifyInboxByEmail($email,'inbox') ?></div>
          </li>
          ...
          <ul class="list-unstyled mb-0 mt-2">
            <li data-target="business">
              <a href="javascript:void(0);">
                ...
                <span class="align-middle ms-2">Business</span>
              </a>
            </li>
            <li data-target="mentoring">
              <a href="javascript:void(0);">
                <span class="badge badge-dot bg-primary"></span>
                <span class="align-middle ms-2">Mentoring</span>
              </a>
            </li>
            <li data-target="work">
              <a href="javascript:void(0);">
            ...
            <li data-target="information">
              <a href="javascript:void(0);">
                ...
                <span class="align-middle ms-2">Information</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <div class="shadow-none border-0">
        ...
        <div class="email-list pt-0">
          ...
          <ul class="list-unstyled m-0">
            ...
            <li class="email-list-item" data-starred="true" data-bs-toggle="sidebar" data-target="#app-email-view" lms="<?php echo $notifyInbox['ref_id'] ?>">
              <div class="d-flex align-items-center">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <span class="email-list-item-subject d-xl-inline-block d-block"> <?php echo $notifyInbox['subject']; ?></span>
                </div>
            ...
            <?php } ?>
            <?php $notifyDataSent = $this->gfa_model->getNotificationBox($email,"sent"); foreach($notifyDataSent as $notifySent){ ?>
            <li class="email-list-item email-marked-read" data-sent="true" data-bs-toggle="sidebar" data-target="#app-email-view" lms="">
              <div class="d-flex align-items-center">
                <div class="form-check mb-0">
                ...
                <i class="email-list-item-bookmark ti ti-star ti-sm d-sm-inline-block d-none cursor-pointer ms-2 me-3"></i>
                <!--<img src="../../assets/img/avatars/2.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-3 me-2" height="32" width="32" />-->
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  <span class="h6 email-list-item-username me-2"><?php  echo ucwords($this->gfa_model->getAllRegisteredName($account_type,$email)); ?></span>
                  <span class="email-list-item-subject d-xl-inline-block d-block"> <?php echo $notifySent['subject']; ?></span>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
            ...
            <?php } ?>
            <?php $notifyDataDraft = $this->gfa_model->getNotificationBox($email,"draft"); foreach($notifyDataDraft as $notifyDraft){ ?>
            <li class="email-list-item" data-draft="true" data-bs-toggle="sidebar" data-target="#app-email-view">
              <div class="d-flex align-items-center">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  <span class="h6 email-list-item-username me-2"><?php  echo ucwords($this->gfa_model->getAllRegisteredName($account_type,$email)); ?></span>
                  <span class="email-list-item-subject d-xl-inline-block d-block"> <?php echo $notifyDraft['subject']; ?></span>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
            ...
            <?php }  ?>
            <?php $notifyDataTrash = $this->gfa_model->getNotificationBox($email,"trash"); foreach($notifyDataTrash as $notifyTrash){ ?>
            <li class="email-list-item email-marked-read" data-trash="true" data-bs-toggle="sidebar" data-target="#app-email-view">
              <div class="d-flex align-items-center">
                ...
                <i class="email-list-item-bookmark ti ti-star ti-sm d-sm-inline-block d-none cursor-pointer ms-2 me-3"></i>
                <img src="../../assets/img/avatars/9.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-3 me-2" height="32" width="32" />
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  <span class="h6 email-list-item-username me-2">Alistai<?php  echo ucwords($this->gfa_model->getAllRegisteredName($account_type,$email)); ?></span>
                  <span class="email-list-item-subject d-xl-inline-block d-block"> <?php echo $notifyTrash['subject']; ?></span>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  <span class="email-list-item-label badge badge-dot bg-primary d-none d-md-inline-block me-2" data-label="company"></span>
      ...
      <div class="card shadow-none border-0 rounded-0 app-email-view-header p-3 py-md-3 py-2">
        ...
        <div class="d-flex justify-content-between align-items-center py-2">
          <div class="d-flex align-items-center overflow-hidden">
            ...
            <h6 class="text-truncate mb-0 me-2 app-email-viewX">Focused impactful open issues</h6>
        ...
        <div class="card email-card-prev mx-sm-4 mx-3">
          <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
            <div class="d-flex align-items-center mb-sm-0 mb-3">
              <img src="../../assets/img/avatars/2.png" alt="user-avatar" class="flex-shrink-0 rounded-circle me-3" height="40" width="40" />
    ...
    <div class="modal-dialog m-0 me-md-4 mb-4 modal-lg">
      <div class="modal-content p-0">
        <div class="modal-header py-3 bg-body">
          <h5 class="modal-title fs-5">Compose Message</h5>
