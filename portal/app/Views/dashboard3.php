                            ...
                            <div class="card">
                                <a href="<?php echo base_url('gfa/perks'); ?>">
                                    ...
                                    <div class="card-header flex-column align-items-start pb-0">
                                        ...
                                        ?>
                                        <h2 class="fw-bolder mt-1"> <?php echo number_format(600, 0, '.', ','); ?> XOF
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between">
                                                <span><?php echo  $this->gfa_model->countAllSME() ?>
                                                    SME</span>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-end mt-1 pt-25">
                                                <div class="role-heading">
                                                    <h4 class="fw-bolder">SMEs</h4>
                                                    <!--<a href="javascript:;" class="role-edit-modal" data-bs-toggle="modal" data-bs-target="#addRoleModal">-->

                                                    <small class="fw-bolder"><a
                                                            href="<?php echo base_url('gfa/connected_sme'); ?>">Connect
                                                            </a> | <a
                                                            href="<?php echo base_url('gfa/find_sme'); ?>">Search
                                                            </a></small>
   ...
   <?php  }  ?>    
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between">
                                                <span><?php if($this->gfa_model->countResourceUploded()==1 || $this->gfa_model->countResourceUploded()==0  ){
                                                    echo $this->gfa_model->countResourceUploded($email).' File';
                                                    
                                                }else{ 
                                                        echo $this->gfa_model->countResourceUploded($email)." Files";
                                                        
                                                        } ?> </span>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-end mt-1 pt-25">
                                                <div class="role-heading">
                                                    <h4 class="fw-bolder">Resources</h4>
                                                    <!--<a href="javascript:;" class="role-edit-modal" data-bs-toggle="modal" data-bs-target="#addRoleModal">-->

                                                    <small class="fw-bolder">
                                                   
 <a class="d-flex align-items-center" href="<?php echo base_url('gfa/resource'); ?>"> View Resources</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        ...
                        <?php  if($point > 50){ ?>
                            ...
                            <a href="<?php echo base_url('gfa/learning'); ?>"   class="btn btn-primary float-end mt-3" >
