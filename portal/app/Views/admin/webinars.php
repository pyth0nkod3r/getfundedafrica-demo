          ...
          <div class="box">
            ...
            <div class="box-body">
               ...
               <table id="example1" class="table table-bordered table-striped">
				...
				$n= 1;
				$rows = $admin_model->getAllWebinarReg($event);  foreach($rows as $rowArray){  
				$rowStartup = $admin_model->getAllStartUpNByEmail($rowArray['email']);  
				$rowStartup_Ext = $admin_model->getAllStartUpNByEmailExtX($rowArray['email'])	
