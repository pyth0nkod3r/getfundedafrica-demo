...
<!--   The investor name & title -->
            ...
            <h4 class="card-title">Recommended Startups for Corporate</h4>
 ...
 <!-- Company Table Card -->
    <div class="col-lg-12 col-12">
        <div class="col-lg-12 text-center mb-2">
         ...
         <?php   if(!empty($this->admin_model->getCorperateMicrosoftByEmail($email))){  ?>
            <a href="<?php echo base_url(); ?>gfa/corperates" class="btn btn-primary btn-next" style="margin:5px;" disabled>Connect to other Corporates </a>   <a href="#" class="btn btn-primary btn-next" style="margin:5px;" data-bs-target="#checkInterview" data-bs-toggle="modal"> Request an Interview </a> <a href="<?php echo base_url(); ?>gfa/calendar" style="margin:5px;" class="btn btn-primary btn-next" > Schedule Meeting </a>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <span><?php echo str_replace("?","",$this->gfa_model->getStartUpDetails($rowArray['Email'])[0]['PrimaryBusinessIndustry']); ?><br>
                      <?php echo $rowArray['Solution_Corperate']; ?><br>
                          <?php echo $rowArray['Startup_Model']; ?></span>
                    </div>
                  </td>
                  ...
                  | <a href="<?php echo base_url(); ?>gfa/corperate_startup_details/<?php echo $rowArray['Id']; ?>" >   <span class="fw-bolder me-1">Meet Innovators</span>
                      <i data-feather="trending-up" class="text-success font-medium-1"></i></a> | <a href="<?php echo base_url(); ?>gfa/calendar?e=<?php echo $rowArray['Email'];  ?>" >   <span class="fw-bolder me-1">Schedule Meeting</span>
