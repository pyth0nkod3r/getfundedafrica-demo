 ...
 <div class="app-content content ">
      ...
      <div class="content-wrapper container-xxl p-0">
        ...
        <?php //$checkYourStory = $this->gfa_model->getEventByTitle($story_title); ?>
...
<div class="blog-list-wrapper">
  ...
  <div class="row">
      ...
      <?php 
$row =  $this->gfa_model->getAllCsr(); foreach($row as $rowStoryArray){ ?>
    <div class="col-md-6 col-12">
      <div class="card">
        <a href="page-blog-detail.html">
          <img class="card-img-top img-fluid" src="<?php echo base_url()?>uploads/files/<?php echo $rowStoryArray['picture'] ?>" alt="CSR Post pic" />
        </a>
        <div class="card-body">
          <h4 class="card-title">
            <a href="<?php echo base_url()?>gfa/csr/<?php echo $rowStoryArray['title']; ?>" class="blog-title-truncate text-body-heading"
      ...
      if(empty($getPhoto)){
         ...
         $showPhoto = "uploads/onboarding/".$getPhoto[0]['Photo_name']; 
          ...
          <p class="card-text blog-content-truncate">
            <?php echo substr($rowStoryArray['event'],0,30) ?>...
          </p>
          <hr />
...
$row =  $this->gfa_model->getEventLimit10(); foreach($row as $rowStoryArray){ ?>
      <div class="d-flex mb-2">
        <a href="<?php echo base_url()?>gfa/events/<?php echo $rowStoryArray['title']; ?>" class="me-2">
          <img
            class="rounded"
