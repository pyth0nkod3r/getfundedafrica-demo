    ...
    <div class="col-md-6 col-12">
      <div class="card">
        <a href="page-blog-detail.html">
          <img class="card-img-top img-fluid" src="<?php echo base_url("uploads/files/{$rowStoryArray['picture']}"); ?>" alt="Event Post pic" />
        </a>
        <div class="card-body">
          <h4 class="card-title">
            <a href="<?php echo base_url("gfa/events/{$rowStoryArray['ref_id']}")?>" class="blog-title-truncate text-body-heading"
      ...
      if(empty($getPhoto)){
         ...
         $showPhoto = "uploads/onboarding/".$getPhoto[0]['Photo_name']; 
            ...
            <div class="author-info">
              ...
              <small><a href="#" class="text-body"><?php if( !empty($this->gfa_model->getStartUpDetails($rowStoryArray['email'])[0]['Primary_Contact_Name'])){

                echo $this->gfa_model->getStartUpDetails($rowStoryArray['email'])[0]['Primary_Contact_Name'];
          ...
          <div class="my-1 py-25">
            <a href="#">
              <span class="badge rounded-pill badge-light-info me-50"><?php 
              if( !empty($this->gfa_model->getStartUpDetails($rowStoryArray['email'])[0]['Startup_Company_Name'])){

                echo $this->gfa_model->getStartUpDetails($rowStoryArray['email'])[0]['Startup_Company_Name'];
            ...
            <a href="#">
              <span class="badge rounded-pill badge-light-primary"></span><?php 
              if( !empty($this->gfa_model->getStartUpDetails($rowStoryArray['email'])[0]['PrimaryBusinessIndustry'])){

                echo $this->gfa_model->getStartUpDetails($rowStoryArray['email'])[0]['PrimaryBusinessIndustry'];
