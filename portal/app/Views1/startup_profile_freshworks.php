  ...
  <div class="col-12">
    <div class="card"></div>
      <center><br>
<img src="https://getfundedafrica.com/portal/assets/images/roundtable_with_funke.png">
<br><br></center>
    <!-- profile -->
    <div class="card">
      <div class="card-header border-bottom">
        ...
        Business Sustainability in high Inflation Economy

      </div>
      
      <div class="card-header border-bottom">
        
        <p style="white-space: pre-line"><strong>Topic: </strong> Roundtable talk with Funke Bucknor-Obruthe: Business Sustainability in a High-Inflation Economy</p>
        
        <p style="white-space: pre-line"><strong>Description: </strong> Twenty years as a foremost event planner has earned Funke Bucknor-Obruthe a place amongst Nigeria's industry leaders. She is the founder and current C.E.O. of the Zapphaire Events Group (comprising Zapphaire Events Limited, The Zapphaire Training Academy and Decor by Furtullah) a pioneer events planning company in Africa that has for many years continued to set the trend for event architecture and design in Nigeria.

Funke's passion for innovation and excellence has built a leading Wedding and Events brand that has delivered well over 2,500 successful events across the globe and has still remained relevant.
...
She has also been featured on CNN.
...
Join us as she shares knowledge about her experience and how she has been able to sustain her business even in trying times. </p>

        <p style="white-space: pre-line"><strong>Time: </strong> Feb 13, 2023 01:00 PM in West Central Africa</p>
...
<option value="Accessing new markets/customers">Accessing new markets/customers</option>
 ...
 <option value="Aggregation of data and gaining new insights">Aggregation of data and gaining new insights</option>
    ...
    e.preventDefault();
     ...
     data:startupInfo,
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/startupProfileFreshworksPro",
