  ...
  <div class="modal-dialog modal-dialog-centered modal-edit-user">
    <div class="modal-content">
      ...
      <div class="modal-body pb-5 px-sm-5 pt-50">
        ...
        <p>
             Your profile update is <?php echo $point ?>%, pls update it to aleast 50%. 
        </p>
      ...
      <div class="modal-body pb-5 px-sm-5 pt-50">
        <div class="text-center mb-2">
         <span><i data-feather="info" class="font-large-2 me-sm-2 mb-2 mb-sm-0"></i></span><h1 class="mb-1">Profile Completion</h1>
          <!--<p><a href="http://estore.getfundedafrica.com/sso.php?key=<?php //echo $loginkey[0][LoginKey]; ?>" target="_blank">Click here to visit estore</a></p>-->
        <p>
             Your profile update is <?php echo $point ?>%, pls update it to aleast 50% to access free courses.
        </p>
...
<!-- BEGIN: Footer-->
    ...
    <script src="<?php echo base_url(); ?>assets/app-assets/vendors/js/tables/datatable/jszip.min.js"></script>
    ...
    <script src="<?php echo base_url(); ?>assets/app-assets/vendors/js/tables/datatable/dataTables.rowGroup.min.js"></script>
     <script src="<?php echo base_url(); ?>assets/app-assets/js/scripts/tables/table-datatables-advanced.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/app-assets/vendors/js/forms/validation/jquery.validate.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/app-assets/vendors/js/forms/cleave/cleave.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/app-assets/vendors/js/forms/cleave/addons/cleave-phone.us.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo base_url(); ?>assets/app-assets/js/scripts/pages/app-user-list.min.js"></script>
    <!-- END: Page JS-->
...
<!-- Mirrored from pixinvent.com/demo/vuexy-html-bootstrap-admin-template/html/ltr/vertical-menu-template-bordered/app-user-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 May 2022 06:59:04 GMT -->
</html>