...
<i data-feather="list" class="user-timeline-title-icon"></i>
            <h4 class="card-title">Corperate Details</h4>
  ...
  <div class="row">
    ...
    <div class="col-xl-12 col-lg-5 col-md-5 order-1 order-md-0">
      ...
      <?php	
                ...
                $rowArray = $this->admin_model->getAllStartUpNByEmailExt($id); 
               $row = $this->admin_model->getAllStartUpNByEmail($rowArray[0]['Email']); 
