...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('public/assets/app-assets/vendors/css/editors/quill/katex.min.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('public/assets/app-assets/vendors/css/editors/quill/monokai-sublime.min.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('public/assets/app-assets/vendors/css/editors/quill/quill.snow.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('public/assets/app-assets/vendors/css/editors/quill/quill.bubble.css'); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('public/assets/app-assets/css/plugins/forms/form-quill-editor.min.css'); ?>">
    <!-- END: Page CSS-->
