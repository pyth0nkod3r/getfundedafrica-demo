          ...
          <div class="box">
            ...
            <div class="box-body">
               ...
               <table id="example1" class="table table-bordered table-striped">
				...
				<?php 
			    $n = 1;
				$row = $admin_model->getAllInvestorN();  foreach($row as $rowArray){  
				...
				?>
                  <tr>
                    ...
                    <td>
                    <?php echo $admin_model->countAllConnections($rowArray['Contact_Email']); ?>
                    </td>
                    <td>
                    <?php echo $admin_model->getInvestorsFileUploadedByEmail($rowArray['Contact_Email'])[0]['status']; ?>
                    </td>
