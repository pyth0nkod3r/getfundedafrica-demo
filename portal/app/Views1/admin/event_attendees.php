        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title"><?php echo $admin_model->getEventsPostById($id)[0]['title'] ?></h3>
            </div>
            <!-- /.box-header -->
            ...
            <form class="pull-right" method="POST" action="<?php echo base_url(); ?>download/export/wp_event/wp_id">
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php 
				$n = 1;
				$row = $admin_model->getAllWpEventById($id);  foreach($row as $rowArray){  
				...
				?>
                  <tr class="myTable<?php //echo $rowArray['id'] ?>">
                    ...
                    echo $admin_model->getAllStartUpNByEmail($rowArray['email'])[0]['Primary_Contact_Name']; 
                    }
                    ?></td>
