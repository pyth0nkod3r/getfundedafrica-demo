     ...
     <div class="row displayForm">
        <div class="col-md-6">
          ...
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Post Cohort </h3>
            </div>
            <div class="box-body">
              <!-- Color Picker -->
              ...
              <div class="box-body">
                <div class="form-group">
                  <input type="text" name="Title" class="form-control" required placeholder="Title of Cohort e.g Microsoft">
                </div>
                <div class="form-group">
                  <input type="text" name="Short_Desc" class="form-control" required placeholder="Short Description of Cohort">
                </div>
                <div class="form-group">
                 <div class="input-group date">
                  ...
                  <input type="text" name="Date" class="form-control pull-right" id="datepicker" required placeholder="Date of Cohort">
                </div>
                </div>
               
                <div class="form-group">
                  <input type="text" name="Cohort_Program" class="form-control" required placeholder="Location">
                </div>
                <div class="form-group">
                  <input type="text" name="Cohort_Duration" class="form-control" required placeholder="Duration in weeks">
                </div>
                <div class="form-group">
                  <input type="text" name="Cohort_Type" class="form-control" required placeholder="Cohort Session">
                </div>
                <div class="form-group">
                  <input type="text" name="Fee" class="form-control" required placeholder="Fee">
                </div>
                <div class="form-group">
                     <div class="input-group date">
                  <div class="input-group-addon">
                  ...
                  <input type="text" name="Demo_Date" class="form-control pull-right" id="datepicker1" required placeholder="Demo Date">
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                     <textarea id="editor1" name="Main_Desc" rows="5" cols="100">
                           About the Cohort                 
                    </textarea>
                  </div>
                </div>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary cohortBtn">Submit</button>
              </div>
...
<script>
 ...
 $("#investorsForm").submit(function(e) {
    ...
    $.ajax({
     data:formData,
     type: "POST",
     url: "<?php echo base_url(); ?>admin/cohort_upload",
