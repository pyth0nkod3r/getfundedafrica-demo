      ...
      <?php } } ?>
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo $admin_model->countWebinarAttendance('how-to-pitch'); ?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo $admin_model->countWebinarAttendance('impact-on-africa-tech-ecosystem'); ?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo $admin_model->countWebinarAttendance('transforming-kyc'); ?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo $admin_model->countPoeInvestment(); ?></h3>
              <p>Peo Investment</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo $admin_model->countAllUsersStartup() ?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo $admin_model->countOnboardingStartups() ?><sup style="font-size: 20px"></sup></h3>
