      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <form class="pull-right" method="POST" action="<?php echo base_url(); ?>Export/export/cooperate_info/Event/">
               ...
               <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <th>Solution Corperate </th>
                  <th>Core Interest Corporate</th>
				...
				$row = $this->admin_model->getAllCorporateNMicrosft($Event);  foreach($row as $rowArray){  
				...
				?>
                  <tr>
                    ...
                    <td>
                    <?php echo $rowArray['Corporate_ID'] ; ?>
                    </td>
