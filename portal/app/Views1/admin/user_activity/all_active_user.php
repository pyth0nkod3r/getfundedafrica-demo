            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <?php 
                      $n = 1;
                      $active_emails = $admin_model->getActiveUsers();  
                      foreach($active_emails as $active_email){
					        ?>
                  <tr>
                    <td><?php echo $n++; ?></td>
                    
                    <td><?php echo $gfa_model->getSortedUserData($active_email)['Name']; ?></td>
                    <td><?php echo $gfa_model->getSortedUserData($active_email)['PersonalName']; ?></td>
                    <td><?php echo $active_email; ?></td>
                    <td><?php echo $admin_model->getRecentActivity($active_email)['UserAction']; ?></td>
                    <td><?php echo $admin_model->getRecentActivity($active_email)['UserIp']; ?></td>
