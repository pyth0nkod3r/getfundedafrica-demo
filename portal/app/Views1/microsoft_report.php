...
<!--Options to reach out -->
 <!-- Company Table Card -->
  ...
  <?php       
                $row = $this->admin_model->getCorperateMicrosoftByEmailReport(); 
     //Financial Services
          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                       <strong><?php echo $rowArray['Key_contact_name'] ; ?></strong>
                ...
                $m = 1;
                $rowStartup = $this->admin_model->MatchMicrosftStartup($rowArray['Solution_Corperate'],$rowArray['Core_Interest_Corporate']); 
                
                	foreach($rowStartup as $rowStartupArray){ 
              if($this->admin_model->getAllStartUpNByEmail($rowStartupArray['Email'])[0]['Startup_Company_Name']!='') {  
                echo $m++. '. '.$this->admin_model->getAllStartUpNByEmail($rowStartupArray['Email'])[0]['Startup_Company_Name'].'<br>';	    
