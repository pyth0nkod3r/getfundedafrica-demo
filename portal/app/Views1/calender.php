        ...
        <div class="modal modal-slide-in event-sidebar fade" id="add-new-sidebar">
            ...
            <div class="modal-content p-0">
                ...
                <form class="event-form needs-validation" data-ajax="false" onsubmit="create_event_calender()" novalidate>
                    <input type="hidden" id="host" value="<?php echo $user_email; ?>" />
                    ...
                    <div class="form-check form-switch">
                        ...
                        <div class="mb-1">
                            <label for="guests" class="form-label">Company You Want to Connect With</label>
                            <select id="guests" name="event-guests" class="select2 form-select" onclick="">
                                <option value="">Select Company</option>
                                <?php foreach($event_users as $users) { ?>
                                    <option value="<?php echo $users['Email']; ?>" <?php echo ($select_email == $users['Email']) ? 'selected' : '' ; ?>><?php echo $users['Name']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="mb-1">
