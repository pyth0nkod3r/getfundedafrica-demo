...
<div class="blog-list-wrapper">
  ...
  <div class="row">
      ...
      <?php 
$row =  $this->gfa_model->getTellYourStoryActive(); foreach($row as $rowStoryArray){ ?>
    <div class="col-md-6 col-12">
      <div class="card">
        ...
        <div class="card-body">
          <h4 class="card-title">
            <a href="<?php echo base_url()?>gfa/tellyourstory/<?php echo $rowStoryArray['title']; ?>" class="blog-title-truncate text-body-heading"><?php echo $rowStoryArray['title'] ?></a>
          </h4>
          <div class="d-flex">
      ...
      if(empty($getPhoto)){
         ...
         $showPhoto = "uploads/onboarding/".$getPhoto[0]['Photo_name']; 
          ...
          <p class="card-text blog-content-truncate">
            <?php echo substr($rowStoryArray['story'],0,30) ?>...
          </p>
          <hr />
