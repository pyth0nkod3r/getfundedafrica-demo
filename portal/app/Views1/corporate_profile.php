...
<br><br></center>
    ...
    <div class="card">
      <div class="card-header border-bottom">
        ...
        <h4 class="card-title">Corporate Registration:</h4><br>
        
        Enterprise & Corporate Matchmaking for Startups Event - Morocco
...
<option value="Zimbabwe">Zimbabwe</option> 
          ...
          <div class="col-12 col-sm-6 mb-1">
              ...
              <select id="country" name="Attendance" class=" form-control form-select">
    ...
    <option value="Telecommunication">Telecommunication</option>
            ...
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountReadiness">How would you like to engage with startups</label>
              <!-- <label class="form-label" for="accountReadines" style="color:#ff0000;">* Product / Tech Readines?</label>-->
    ...
    <option value="D2C/B2C">D2C/B2C</option>
                  ...
                  <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountReadiness">Core Corporate Interest</label>
              <!-- <label class="form-label" for="accountReadines" style="color:#ff0000;">* Product / Tech Readines?</label>-->
...
<option value="Accessing new markets/customers">Accessing new markets/customers</option>
 ...
 <option value="Aggregation of data and gaining new insights">Aggregation of data and gaining new insights</option>
    ...
    e.preventDefault();
     ...
     data:startupInfo,
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/corperateProfileMicrosftPros",
     error:function() {$(".displayAction").html('Error saving data');},
	 beforeSend:function() {$(".saveBtn").html('Saving Profile...');},
      success: function(data) {
       //
		  $(".displayAction").html("Successful Registration! Please check your email for more details");  
	   $(".saveBtn").html('Saved');  
