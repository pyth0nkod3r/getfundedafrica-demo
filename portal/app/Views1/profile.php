  ...
  <div class="col-12">
    ...
    <?php if($this->gfa_model->getPhotoUploaded($email)[0]['Photo_name']==""){ ?>
     ...
     <div style="color:#ff0000;">* Zip Code</div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['Startup_Company_Name']==""){ ?>
     <div style="color:#ff0000;">* Startup/Company Name</div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['PrimaryBusinessIndustry']==""){ ?>
     <div style="color:#ff0000;">* Industry</div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['Date_Founded']==""){ ?>
     <div style="color:#ff0000;">* Date Founded</div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['CurrentInvestmentStage']==""){ ?>
     <div style="color:#ff0000;">* Current Stage</div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['Startup_Implementation_Stage']==""){ ?>
     <div style="color:#ff0000;">* Implementation Stage</div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['OperatingRegions']==""){ ?>
     <div style="color:#ff0000;">* Operation Region</div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['CountryHQ']==""){ ?>
     <div style="color:#ff0000;">* Startup Country</div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['Next_Funding_Round_Target_Sought']==""){ ?>
     <div style="color:#ff0000;">* Funding to raise ($)</div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['Revenue']==""){ ?>
     <div style="color:#ff0000;">* Annual Revenue</div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['NoOfEmployees']==""){ ?>
     
     <div style="color:#ff0000;">* No of Employees</div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['Website']==""){ ?>
     <div style="color:#ff0000;">* Website</div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['LinkedIn']==""){ ?>
     <div style="color:#ff0000;">* LinkedIn Profile</div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['Facebook']==""){ ?>
     <div style="color:#ff0000;">* Facebook Profile</div>
      <?php }  ?>
     <?php if($this->gfa_model->getStartUpDetails($email)[0]['Hear_Us']==""){ ?>
     <div style="color:#ff0000;">* How did you hear about us?</div><br>
      <?php }  ?>
      <?php if($this->gfa_model->getStartUpDetails($email)[0]['Hear_Us']==""){ ?>
     <div style="color:#ff0000;">* How did you hear about us?</div><br>
      <?php }  ?>
      <?php if($this->gfa_model->getStartUpDetails($email)[0]['Mentorship']==""){ ?>
     <div style="color:#ff0000;">* What areas you’d like mentorship?</div><br>
      <?php }  ?>
...
<option value="Zimbabwe">Zimbabwe</option> 
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <input type="text" class="form-control" id="accountAddress" name="address" placeholder="Your Address" value="<?php echo $this->gfa_model->getStartUpDetails($email)[0]['Address'];  ?>" />
            </div>
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <!-- <label class="form-label" for="accountFirstName" style="color:#ff0000;">* Startup/Company Name</label>-->
              <input
                type="text"
                class="form-control"
...
<option value="Zimbabwe">Zimbabwe</option>
    ...
    e.preventDefault();
     ...
     data:startupInfo,
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/startupProfilepro",
