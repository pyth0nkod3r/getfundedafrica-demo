      ...
      <div class="card card-user-timeline">
        <div class="card-header">
          <div class="d-flex align-items-center">
            ...
            <h4 class="card-title"><a href="https://getfundedafrica.com/portal/gfa/comingsoon">Tell your Story</a></h4>
          </div>
        </div>
        <div class="card-body">
        ...
        <!--<div class="col-lg-4 col-md-6 col-12">-->
         <a href="#" class="btn btn-primary col-md-6" style="float:auto;">+ Add Story</a> 
         <!--</div>-->
      </div>
    </div>
    <!--/ Timeline Card -->
        ...
        <div class="profile-image-wrapper">
          <div class="profile-image">
            <div class="avatar">
              ...
              <img src="https://getfundedafrica.com/portal/uploads/49917bda73f9a067e6abe22c088c718a.jpg" alt="Cohort Picture" />
            </div>
          </div>
        </div>
        ...
        <input type="hidden" class="eventId" value="<?php echo $eventResp['ID']; ?>" >
         ...
         <?php if($this->gfa_model->getWpEvent($email)[0]['status']=='active'){  ?>
          <div class="avatar-content avatar  p-50 m-0 bg-light-primary" style="float:right;">
           ...
           <?php }else{  ?>
            <button type="button" class="btn btn-primary attendEvent" disabled>Event Closed</button>
           <?php } ?>
            </div>
