 ...
 ?>
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow container-xxl">
              ...
              <!--<li class="scrollable-container media-list"><a class="d-flex" href="#">
                  <div class="list-item d-flex align-items-start">
                    ...
                    <div class="list-item-body flex-grow-1">
                      <p class="media-heading"><span class="fw-bolder">Congratulation Seun 🎉</span></p><small class="notification-text"> Welcome to GFA.</small>
                    </div>
                  ...
                  <div class="list-item d-flex align-items-start">
                    ...
                    <div class="list-item-body flex-grow-1">
                      <p class="media-heading"><span class="fw-bolder">New Investors Match</span>&nbsp;Found</p><small class="notification-text"> You have 0 unread messages</small>
                    </div>
                  </div></a><a class="d-flex" href="#">
                  <div class="list-item d-flex align-items-start">
                    <div class="me-1">
                    ...
                    <div class="list-item-body flex-grow-1">
                      <p class="media-heading"><span class="fw-bolder">Announcement 👋</span>&nbsp;New Partnership</p><small class="notification-text"> With Microsoft</small>
                    </div>
                  </div></a>
                <div class="list-item d-flex align-items-center">
                  ...
                  <div class="list-item d-flex align-items-start">
                    ...
                    <div class="list-item-body flex-grow-1">
                      <p class="media-heading"><span class="fw-bolder">You have just</span>&nbsp;registered</p><small class="notification-text"> Welcome to GFA</small>
                    </div>
                  </div></a><a class="d-flex" href="#">
                  <div class="list-item d-flex align-items-start">
                    <div class="me-1">
                    ...
                    <div class="list-item-body flex-grow-1">
                      <p class="media-heading"><span class="fw-bolder">Your Password</span>&nbsp;have just been changed</p><small class="notification-text"> Just now</small>
                    </div>
                 </a>
              </li>
          ...
          <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">
                 ...
                 if(empty($account_type)){
                  ...
                  echo ucwords($this->gfa_model->getStartUpDetails($email)[0]['Primary_Contact_Name']);
                     }
                ...
                ?>  
                  ...
                  <?php  if(empty($account_type)){ echo "TIME OUT"; }else { echo strtoupper($this->gfa_model->getStartUpDetails($email)[0]['Startup_Company_Name']); } ?>
              <?php  
      ...
      ?>
            ...
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user"><a class="dropdown-item" href="<?php echo base_url('gfa/profile'); ?>"><i class="me-50" data-feather="user"></i> Profile</a>
            <a class="dropdown-item" href="<?php echo base_url('gfa/invite_users'); ?>"><i class="me-50" data-feather="credit-card"></i>Invite User</a>
