        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Update Perks</h2>
...
<!--            </div>-->
        <div class="card-body">
            ...
            <?php   
              ...
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  ...
                  <option value="<?php echo $updatePerks[0]['sub_type'];?>"><?php echo $updatePerks[0]['sub_type']; ?></option>    
              ...
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  ...
                  <option value="<?php echo $updatePerks[0]['perks_type'];?>"><?php echo $updatePerks[0]['perks_type']; ?></option>    
              ...
              <label>Company Name</label>
                <div class="mb-2">
                  <input type="text" name="company_name" class="form-control" required placeholder="Company Name" value="<?php echo $updatePerks[0]['company_name']; ?>" />
                </div>
              </div>
              ...
              <!-- <label class="form-label" for="accountFirstName" style="color:#ff0000;">* Industry</label>-->
               ...
               <?php  $categoryArray = explode(",",$updatePerks[0]['category']); 
               $number_of_entries = sizeof($categoryArray); 
               ?>
               <?php for ($j = 0; $j < $number_of_entries; $j++){  ?>
               <option value="<?php echo $categoryArray[$j];  ?>" selected><?php echo $categoryArray[$j];  ?></option>
               <?php }  ?>
              ...
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" class="form-control" name="title" placeholder="Title of Perks" value="<?php echo $updatePerks[0]['title']; ?>" />
                </div>
              </div>
               ...
               <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" class="form-control" name="tags" placeholder="Tags" value="<?php echo $updatePerks[0]['tags']; ?>" />
                </div>
              </div>
               <div class="col-sm-6 col-12">
              
                <div class="mb-2">
                  <input type="text" class="form-control" name="note" placeholder="Note" value="<?php echo $updatePerks[0]['note']; ?>" />
                </div>
              </div>
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="text" class="form-control" name="value_1" placeholder="Value" value="<?php echo $updatePerks[0]['value_1']; ?>" />
                </div>
              </div>
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="number" class="form-control" name="value_2" placeholder="Value in number(Amount in USD($)" value="<?php echo $updatePerks[0]['value_2']; ?>" />
                </div>
              </div>
               <div class="col-sm-6 col-12">
              
                <div class="mb-2">
                  <input type="text" class="form-control" name="qty" placeholder="Quantity" value="<?php echo $updatePerks[0]['qty']; ?>" />
                </div>
              </div>
              <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <select  class="form-select" name="status" placeholder="Status">
                  <option value="<?php echo $updatePerks[0]['status'];?>"><?php echo $updatePerks[0]['status']; ?></option>    
               ...
               <div class="col-sm-6 col-12">
                <div class="mb-2">
                  <input type="number" class="form-control" name="rating" placeholder="Rating" value="<?php echo $updatePerks[0]['rating']; ?>" />
                </div>
              </div>
               <div class="col-sm-6 col-12">
              
                <div class="mb-2">
                  <input type="text" class="form-control" name="aff_link" placeholder="Affliate link" value="<?php echo $updatePerks[0]['aff_link']; ?>" />
                </div>
              </div>
          ...
          <input
            ...
            value="<?php echo $updatePerks[0]['start_date']; ?>"
          />
              ...
              <div class="col-sm-6 col-12">
                ...
                <div class="mb-2">
                  ...
                  <input type="hidden" class="form-control" name='getfile[]' value="<?php echo $updatePerks[0]['logo'] ?>"  />
              ...
              <div id="full-wrapper col-12">
                <div id="full-container" class="mb-2">
                  ...
                  <?php  echo   $this->gfa_model->getPerksByRef($updatePerks[0]['ref_id'])[0]['textdata']; ?>
                  </div>
                </div>
              </div>       
    ...
    <input type="hidden" class="ref_id" name="ref_id" value="<?php echo $updatePerks[0]['ref_id']; ?>">
              <div class="col-12">
