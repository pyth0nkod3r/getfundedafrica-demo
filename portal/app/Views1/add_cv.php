        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Upload your Resume</h2>
...
<option value="Zimbabwe">Zimbabwe</option>
          ...
          <label class="form-label" for="fp-date-time">Date of Birth</label>
          <input
            type="text"
            id="fp-date-time"
    ...
    $.ajax({
     data:formData,
     type: "POST",
     url: "<?php echo base_url(); ?>gfa/cvpostpro",
