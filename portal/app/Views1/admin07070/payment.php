      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <form class="pull-right" method="POST" action="<?php echo base_url(); ?>download/export/package_sub/">
              ...
              <table id="example1" class="table table-bordered table-striped">
			    ...
			    $personalDetailsCohort =  $this->admin_model->getAllCohortByEmail($rowArray['email']);
			    $personalDetailsOldStartup =  $this->admin_model->getAllOldStartupByEmail($rowArray['email']);
				?>
                  <tr class="myTable<?php //echo $rowArray['id'] ?>">
                    ...
                    <td>
                       ...
                       <?php  }  ?>
                        ...
                        <?php if(!empty($personalDetailsOldStartup[0]['name'])){  ?>
                        <strong>Name:</strong>   <?php echo $personalDetailsOldStartup[0]['name']; ?><br> 
                        <strong>Email: </strong><?php echo $personalDetailsOldStartup[0]['email']; ?><br>
                        <strong>Phone:</strong> <?php echo $personalDetailsOldStartup[0]['phone']; ?>
