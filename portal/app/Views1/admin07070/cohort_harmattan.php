        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body" style="overflow: auto; margin: 0 10px;">
                ...
                <form class="pull-right" method="POST" action="<?php echo base_url(); ?>download/export/startup_co/cohort_type">
                <input type="hidden" name="column_value" value="harmattan" >
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php 
				$n = 1;
				$row = $this->admin_model->getCohortHarmattan();  foreach($row as $rowArray){  
					$subType = $this->admin_model->getSubPayX($rowArray['email'],'Investor Readiness Cohort'); 
