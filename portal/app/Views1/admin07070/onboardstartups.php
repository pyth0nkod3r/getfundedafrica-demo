 ...
 <!-- Content Header (Page header) -->
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-3">
		<?php 
					$profile_request = $this->admin_model->getAllStartUpNById($id);
				// 	$ref_request = $this->admin_model->getStartUp($getSub[0]['email']); 
				// 	$getSub = $this->admin_model->getProfile($getSub[0]['email']);  
					$getFile = $this->admin_model->getFile($profile_request[0]['Contact_Email']);
				// 	$getFund = $this->admin_model->getFund($getSub[0]['email']);
					$rowArrayExt = $this->admin_model->getAllStartUpNByEmailExtX($profile_request[0]['Contact_Email']);
      ...
      $getPhoto =  $this->gfa_model->getPhotoUploaded($profile_request[0]['Contact_Email']);  
      if(empty($getPhoto)){
          ...
          <div class="dropdown float-end">
           ...
           <table id="example1" class="table table-bordered table-striped">
				...
				<?php 
			     ...
			     $row = $this->admin_model->getRecentFileUploaded($profile_request[0]['Contact_Email']);
