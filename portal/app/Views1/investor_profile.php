  ...
  <div class="col-12">
     <ul class="nav nav-pills mb-2">
      <!-- account -->
      <li class="nav-item">
        <a class="nav-link  active" href="startup-profile.html">
...
<option value="Zimbabwe">Zimbabwe</option> 
            ...
            <div class="col-12 col-sm-6 mb-1">
             ...
             <div class="col-12 col-sm-6 mb-1">
              ...
              <select id="country" name="industry" class="select2 form-select">
          ...
          <div class="col-12 col-sm-6 mb-1">
            ...
            <?php $row = $this->admin_model->getAllAfricaRegions();  foreach($row as $getAllAfricaRegions){  ?>
              ...
              <select name="startup_country" id="country" class="select2 form-select">
