        ...
        <div class="card-body">
            <form class="form form-vertical gfa1ai2-subscribe" name="gfa1ai2" onsubmit="gfa_subscribe('gfa1ai2'); return false;" action="#">
                <div class="row">
                    ...
                    <input type="hidden" name="gfa1ai2-current-stage" class="gfa1ai2-current-stage" value="Post-Launch" />
                    ...
                    <div class="mb-1 col-md-12">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="vertical-modern-first-name" class="form-control URL-input"
                                name="gfa1ai5-website" placeholder="Site internet"
                                 />
                        </div>
                    </div>
    ...
    title="Le numéro de registre de commerce doit comprendre un minimum de 10 caractères et un maximum de 30 caractères" required />
                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="book"></i></span>
                                <input type="text" id="contact-info-icon" class="form-control" name="gfa1ai5-tax" required pattern=".{10,30}" minlength="10" maxlength="30"
            ...
            <form class="form form-vertical gfa1ci2-venture" name="gfa2ci" onsubmit="gfa_venture_pro('gfa1ci2'); return false;" action="#" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <input type="hidden" name="gfa1ci2-current-stage" class="gfa1ai2-current-stage" value="Post-Launch" />
                    </div>
                    <div class="col-12">
                        <div class="mb-1">
                            <label class="form-label" for="email-id-icon">Sexe</label>
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="map-pin"></i></span>
                                <select name="gfa1ci2-gender" class="form-select" id="basicSelect" required>
                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="book"></i></span>
                                <input type="text" id="contact-info-icon" class="form-control" name="gfa1ci2-trade" pattern=".{10,30}" minlength="10" maxlength="30"
    title="Le numéro de registre de commerce doit comprendre un minimum de 10 caractères et un maximum de 30 caractères" required />
                            </div>
                        </div>
                    </div>
        ...
        <div class="card-body">
            <form class="form form-vertical gfa1di2-report" name="gfa2di" onsubmit="gfa_report('gfa1di2'); return false;" action="#">
                <div class="row">
                    ...
                    <input type="hidden" name="gfa1di2-current-stage" class="gfa1di2-current-stage" value="Post-Launch" />
                    <div class="col-12">
                        <div class="mb-1">
                            <label class="form-label" for="email-id-icon"><?php echo $translations['startup']['form-2']['email']; ?></label>
                            <div class="input-group input-group-merge">
                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="map-pin"></i></span>
                                <select name="gfa1di2-gender" class="form-select" id="basicSelect" required>
                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="file"></i></span>
                                <select name="gfa1di2-model" class="form-select" id="basicSelect" required>
                                    <option value="B2B">B2B</option>
                                    <option value="B2B2C">B2B2C</option>
                                    <option value="B2C">B2C</option>
                                    <option value="B2C/B2B">B2C/B2B</option>
                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="map-pin"></i></span>
                                <select name="gfa1di2-country" class="form-select" id="basicSelect" >
                                    <option>Select country</option>
                                    <option value="Afghanistan">
                                        Afghanistan
                                    </option>
        ...
        <div class="card-body">
            <form class="form form-vertical gfa1ei2-learning" name="gfa2ei" onsubmit="gfa_learning('gfa1ei2'); return false;" action="#">
                <div class="row">
                    ...
                    <input type="hidden" name="gfa1ei2-current-stage" class="gfa1ai2-current-stage" value="Post-Launch" />
                    <!-- <div class="col-12">
                        <div class="mb-1">
                            <label class="form-label" for="password-icon">Password</label>
                            <div class="input-group input-group-merge">
        ...
        <div class="card-body">
            <form class="form form-vertical gfa1fi2-streaming" name="gfa2fi" onsubmit="gfa_streaming('gfa1fi2'); return false;" action="#">
                <div class="row">
                    ...
                    <input type="hidden" name="gfa1fi2-current-stage" class="gfa1ai2-current-stage" value="Post-Launch" />
                    <!--<div class="col-12">-->
                    <!--  <div class="mb-1">-->
                    <!--    <label class="form-label" for="password-icon">Password</label>-->
                    <!--    <div class="input-group input-group-merge">-->
                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="smartphone"></i></span>
                                <input type="text" id="contact-info-icon" class="form-control" name="gfa1fi2-mobile"
                                    placeholder="Entrez un numéro à 10 chiffres" pattern="\d{10}" title="Veuillez entrer exactement 10 chiffres" required />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                     ...
                     <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="users"></i></span>
                                <select name="gfa1fi2-solution" class="form-select" id="basicSelect" required>
                                    <option value=""><?php echo $translations['startup']['form-2']['solution']['blank']; ?></option>
                                    <option value="Digital Banks">Banques numériques</option>
                                    <option value="Energy">Énergie</option>
                                    <option value="Engineering/ESG">Ingénierie/ESG</option>
                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="users"></i></span>
                                <select name="gfa1fi2-core-solution" class="form-select" id="basicSelect" required>
                                    <option value=""><?php echo $translations['startup']['form-2']['solution']['blank']; ?></option>
                                    <option value="Increasing revenue">Augmentation des revenus</option>
                                    <option value="Reducing company costs">Réduction des coûts de lentreprise</option>
                                    <option value="Enhance operational excellence, capabilities or performance management">Amélioration de lexcellence opérationnelle, des capacités ou de la gestion des performances</option>
                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="file"></i></span>
                                <select name="gfa1fi2-own" class="form-select" id="basicSelect" required>
                                    <option value=""><?php echo $translations['startup']['form-2']['solution-own']['blank']; ?></option>
