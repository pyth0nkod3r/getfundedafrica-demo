...
<div class="mb-1 col-md-12">
    <label class="form-label" for="vertical-modern-country"><?php echo $translations['corporate']['form-1']['industry']['head']; ?> <span style="color:red;"> *</span></label>
    <div class="input-group input-group-merge">
        <span class="input-group-text"><i data-feather="anchor"></i></span>
        <select name="industry[]" class="select2 form-select" required multiple="multiple">
            <!-- Removed the default blank option -->
                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <select name="model" class="form-select" id="basicSelect" required>
                     ...
                     <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <select name="solution" class="form-select" id="basicSelect" required>
