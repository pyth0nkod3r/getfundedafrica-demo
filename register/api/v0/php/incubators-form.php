...
<div class="col-md-12 col-12 gfa1aiacc">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <label class="form-label" for="vertical-modern-country">Secteurs d’activité<span style="color:red;"> *</span></label>
                        <div class="input-group input-group-merge">
    ...
    <h3 class="form-label">Quels ressources prévoyez-vous d'offrir aux entreprises que vous incubez/accélérez? <span style="color:red;"> *</span></h3>
    ...
    <div class="formify-forms__quiz-form formify-mg-top-10">
        <div class="formify-forms__quiz-form formify-forms__quiz-form--checkbox">
            <ul class="formify-forms__cdefault formify-forms__cdefault-multiple">
                <li>
                    <input class="formify-forms__input d-none" type="checkbox" value="Co-working space - Hot desk" id="co-working-space" name="resources[]">
                    <label class="formify-forms__cdefault-label" for="co-working-space">Espace de co-working - Bureau partagé</label>
                </li>
                <li>
                    <input class="formify-forms__input d-none" type="checkbox" value="Incubation space" id="incubation-space" name="resources[]">
                    <label class="formify-forms__cdefault-label" for="incubation-space">Espace d'incubation</label>
                </li>
                <li>
                    <input class="formify-forms__input d-none" type="checkbox" value="Business advisory services" id="business-advisory" name="resources[]">
                    <label class="formify-forms__cdefault-label" for="business-advisory">Services de conseils aux entreprises</label>
                </li>
                <li>
                    <input class="formify-forms__input d-none" type="checkbox" value="Access to Entrepreneurs in residence" id="entrepreneurs-in-residence" name="resources[]">
                    <label class="formify-forms__cdefault-label" for="entrepreneurs-in-residence">Accès aux entrepreneurs résidents</label>
                </li>
                <li>
                    <input class="formify-forms__input d-none" type="checkbox" value="Networking events" id="networking-events" name="resources[]">
                    <label class="formify-forms__cdefault-label" for="networking-events">Événements de réseautage</label>
                </li>
                <li>
                    <input class="formify-forms__input d-none" type="checkbox" value="Foundational business training & workshops" id="foundational-training" name="resources[]">
                    <label class="formify-forms__cdefault-label" for="foundational-training">Formations et ateliers de base en entreprise</label>
                </li>
                <li>
                    <input class="formify-forms__input d-none" type="checkbox" value="Advanced or specialized business training" id="advanced-training" name="resources[]">
                    <label class="formify-forms__cdefault-label" for="advanced-training">Formation avancée ou spécialisée en entreprise</label>
                </li>
                <li>
                    <input class="formify-forms__input d-none" type="checkbox" value="Access to funding" id="access-to-funding" name="resources[]">
                    <label class="formify-forms__cdefault-label" for="access-to-funding">Accès au financement</label>
                </li>
                <li>
                    <input class="formify-forms__input d-none" type="checkbox" value="3D Printing & Prototyping" id="3d-printing" name="resources[]">
                    <label class="formify-forms__cdefault-label" for="3d-printing">Impression 3D et prototypage</label>
                </li>
                <li>
                    <input class="formify-forms__input d-none" type="checkbox" value="Others" id="others" name="resources[]">
                    <label class="formify-forms__cdefault-label" for="others">Autres</label>
                </li>
            </ul>
        </div>
    </div>
