...
<html class="no-js skrollr skrollr-desktop" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../assets/css/branding-agency.css" />
        ...
        <div class="container-fluid">
          ...
          <div class="col-auto col-lg-2 me-lg-0 me-auto logos">
            <a class="navbar-brand" href="../assets/index.html">
              ...
              <img
                src="../assets/images/get-funded-africa-logo.png"
                data-at2x="../assets/get-funded-africa-logo.png"
                alt=""
                class="alt-logo"
              />
            </a>
          ...
          <div class="col-auto ms-auto md-ms-0 menu-order position-static">
            ...
            >
              <ul class="navbar-nav alt-font">
                ...
                <li class="nav-item">
                  <a href="../assets/index.html#entrepreneurs" class="nav-link"
                    >Entrepreneurs</a
                  >
                </li>
                <li class="nav-item dropdown dropdown-with-icon-style02">
                  <a href="../assets/index.html#mentors" class="nav-link">Mentors</a>
                  <i
                ...
                <li class="nav-item">
                  <a href="../assets/index.html#investors" class="nav-link"
                    >Investors</a
                  >
                </li>
                <li class="nav-item">
                  <a href="../assets/index.html#organizations" class="nav-link"
                    >Organizations</a
                  >
                </li>
              </ul>
          ...
          <div class="row mb-6">
            ...
            <div class="col-md-2 offset-lg-1 col-6 order-3 order-md-2">
              ...
              <ul>
                ...
                <li><a href="../assets/index.html#entrepreneurs">Entrepreneurs</a></li>
                <li><a href="../assets/index.html#mentors">Mentors</a></li>
                <li><a href="../assets/index.html#investors">Investors</a></li>
                <li><a href="../assets/index.html#organizations">Organizations</a></li>
              </ul>
            </div>
            ...
            <div class="col-md-2 order-1 order-md-4 sm-mb-30px">
              <a href="../assets/index.html" class="footer-logo"
                ><img
                  src="../assets/images/get-funded-africa-logo.png"
                  data-at2x="../assets/images/get-funded-africa-logo.png"
