    ...
    <link rel="apple-touch-icon" href="https://nora.cipme.ci/portal/public/favicon-nora.png">
        <link rel="icon" href="https://nora.cipme.ci/portal/public/favicon-nora.png" sizes="32x32" type="image/png">
    <!--<link rel="shortcut icon" sizes="100x40" type="image/x-icon" href="https://fg-skillnovation.alat.ng/images/ico/favicon.png" />-->
    <!-- <link rel="shortcut icon" sizes="100x40" href="https://fg-skillnovation.alat.ng/images/ico/favicon.png"> -->
    <link
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="app-assets/vendors/css/forms/select/formify.css"
    />
    <link
      rel="stylesheet"
      type="text/css"
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="app-assets/css/themes/dark-layout.min.css"
    />
    <link
      rel="stylesheet"
      type="text/css"
      href="app-assets/css/themes/bordered-layout.min.css"
    />
    <link
      rel="stylesheet"
      type="text/css"
      href="app-assets/css/themes/semi-dark-layout.min.css"
    />
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="app-assets/css/plugins/forms/form-wizard.min.css"
    />
    <!-- END: Page CSS-->
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="https://gfa-tech.com/assets/css/style.css"
    />
    <!-- END: Custom CSS-->
  ...
  <style>
        /* Custom style to ensure proper display */
        .select2-container {
            width: 100% !important;
        }
    </style>
...
.loader {
  ...
  .formify-steps-list__single.pd {
    min-width: 12%;
    min-height: 10px;
    border-radius: 4px;
    background: #dee9fc;
  }
  .formify-steps-list__single.pd.active {
    min-width: 16%;
    background: #4065ed;
  }
  .formify-steps-list__single.pd.done {
    background-color: #84e87c;
  }
  
  .formify-steps-list__single.bsd {
    min-width: 7%;
    min-height: 10px;
    border-radius: 4px;
    background: #dee9fc;
  }
  .formify-steps-list__single.bsd.active {
    min-width: 10%;
    background: #4065ed;
  }
  .formify-steps-list__single.bsd.done {
    background-color: #84e87c;
  }
  
  
  .formify-steps-list__single.be {
    min-width: 25%;
    min-height: 10px;
    border-radius: 4px;
    background: #dee9fc;
  }
  .formify-steps-list__single.be.active {
    min-width: 40%;
    background: #4065ed;
  }
  .formify-steps-list__single.be.done {
    background-color: #84e87c;
  }
  
  .formify-steps-list__single.fin{
    min-width: 20%;
    min-height: 10px;
    border-radius: 4px;
    background: #dee9fc;
  }
  .formify-steps-list__single.fin.active {
    min-width: 28%;
    background: #4065ed;
  }
  .formify-steps-list__single.fin.done {
    background-color: #84e87c;
  }
  
  .formify-steps-list__single.sam {
    min-width: 13%;
    min-height: 10px;
    border-radius: 4px;
    background: #dee9fc;
  }
  .formify-steps-list__single.sam.active {
    min-width: 20%;
    background: #4065ed;
  }
  .formify-steps-list__single.sam.done {
    background-color: #84e87c;
  }
  
  .formify-steps-list__single.prop {
    min-width: 30%;
    min-height: 10px;
    border-radius: 4px;
    background: #dee9fc;
  }
  .formify-steps-list__single.prop.active {
    min-width: 40%;
    background: #4065ed;
  }
  .formify-steps-list__single.prop.done {
    background-color: #84e87c;
  }
  
  .formify-steps-list__single.sub {
    min-width: 99%;
    min-height: 10px;
    border-radius: 4px;
    background: #dee9fc;
  }
  .formify-steps-list__single.sub.active {
    min-width: 99%;
    background: #4065ed;
  }
  .formify-steps-list__single.sub.done {
    background-color: #84e87c;
  }
